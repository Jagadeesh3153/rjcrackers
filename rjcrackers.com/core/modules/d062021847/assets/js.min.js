...
jQuery(function(t) {
        ...
        function c(t) {
            ...
            a != _t && (_t = a, wt = setTimeout(function() {
                i("resize"), !1
            }, ut))
        }

        function i(a) {
            t(".wcpt").trigger("wcpt_layout", {
                source: a
            })
        }

        function r(a) {
            var e = wcpt_util.get_uninit_rows(a, !0),
                c = wcpt_util.get_sc_attrs(a, !0);
            ...
            })), "undefined" != typeof wcpt_sfsi_init && wcpt_sfsi_init(), J(e), wcpt_util.do_once_on_container(a, "wcpt-select-all-init", Y), wcpt_util.do_once_on_container(a, "wcpt-dynamic-filters-lazy-load-init", et);
            var i = o(a);
            if (i.each(function() {
                    var a = t(this),
                        e = s(".wcpt-heading-row", a).last(),
                        c = s(".wcpt-cart-checkbox[data-wcpt-heading-enabled]", a),
                        i = [];
                    c.each(function() {
                        var a = t(this),
                            e = a.closest(".wcpt-cell").index(); - 1 == i.indexOf(e) && i.push(e)
                    ...
                    var e = a.attr("data-wcpt-query-string") ? a.attr("data-wcpt-query-string") : "",
                        c = wcpt_util.parse_query_string(e.substring(1)),
                        i = wcpt_util.get_table_id(a),
                        r = !1,
                        o = t(".wcpt-reset", a);
            ...
            j(a.find(".wcpt-navigation")), pt(), l(a), window.wp && window.wp.mediaelement && window.wp.mediaelement.initialize(), wcpt_util.update_url_by_container(a), a.trigger("wcpt_after_every_load").trigger("wcpt_after_ajax"), e.addClass("wcpt-row--init"), window.wcpt_cart_result_cache && wcpt_cart({
                payload: {
                    use_cache: !0
                }
            }), a.trigger("wcpt_layout", {
                source: "after_every_load"
            })
        }

        function o(t) {
            return p(".wcpt-table:not(.frzTbl-clone-table)", ".wcpt", t)
        }
        ...
        function s(t, a) {
            return p(t, ".wcpt-table:not(.frzTbl-clone-table)", a)
        }

        function p(a, e, c) {
            return t(a, c).filter(function() {
                var a = t(this);
                return a.closest(e).is(c)
            })
        }

        function l(a) {
            var e = S(a);
            if (e.hide_empty_columns) {
                var c = H(a);
                t(".wcpt-cell", c).removeClass("wcpt-hide"), c.each(function() {
                    for (var t = c.find(".wcpt-row").eq(0).children().length; t;) {
                        var a = c.find(".wcpt-cell:nth-child(" + t + ")");
                        a.filter(":empty").length == a.length && a.add(c.find(".wcpt-heading:nth-child(" + t + ")")).addClass("wcpt-hide wcpt-x"), --t
                    }
                })
            }
        }
        ...
        function w(a) {
            var e, c = a.closest(".wcpt-row"),
                i = c.attr("data-wcpt-product-id"),
                r = c.attr("data-wcpt-variation-id"),
                o = a.closest(".wcpt-table-scroll-wrapper");
            return e = r ? '[data-wcpt-variation-id="' + r + '"].wcpt-row.wcpt-product-type-variation' : '[data-wcpt-product-id="' + i + '"].wcpt-row:not(.wcpt-product-type-variation)', t(e, o)
        }

        function _(a) {
            var e = t(this),
                c = e.attr("data-wcpt-link-code"),
                i = w(e),
                r = i.attr("data-wcpt-product-id"),
                o = i.hasClass("wcpt-product-type-variable"),
                n = i.data("wcpt_complete_match"),
                s = i.hasClass("wcpt-product-type-variation"),
                p = i.hasClass("wcpt-product-type-composite"),
                l = i.hasClass("wcpt-product-type-woosb"),
                d = i.hasClass("wcpt-product-has-addons"),
                _ = i.hasClass("wcpt-product-has-measurement"),
                g = i.hasClass("wcpt-product-has-name-your-price"),
                m = "",
                b = {
                    payload: {
                        products: {},
            ...
            if (t("body").hasClass("wcpt-photoswipe-visible")) a.preventDefault();
            else if (-1 === t.inArray(c, ["product_link", "external_link", "custom_field", "custom_field_media_id", "custom_field_acf", "custom"])) {
                if (a.preventDefault(), o) {
                    var y = i.data("wcpt_variation_found"),
                        k = i.data("wcpt_variation_selected"),
                        C = i.data("wcpt_variation_available");
                    if (variation_ops = i.data("wcpt_variation_ops"), variation_ops) {
                        if (!k) return void alert(wcpt_i18n.i18n_make_a_selection_text);
                        if (!y) return void alert(wcpt_i18n.i18n_no_matching_variations_text);
                        if (!C) return void alert(wcpt_i18n.i18n_unavailable_text)
                    }
                }
                if (o || !e.hasClass("wcpt-disabled")) {
                    if (g) {
                        var x = at(i);
                        if (x.length) {
                            var q = !1,
                                z = (x.attr("data-wcpt-product-name"), x.attr("min")),
                                F = x.attr("max");
                            if (x.val() ? z && x.val() < parseFloat(z) ? q = wcpt_nyp_error_message_templates.minimum_js.replace("%%MINIMUM%%", woocommerce_nyp_format_price(z, woocommerce_nyp_params.currency_format_symbol, !0)) : F && x.val() > parseFloat(F) && (q = wcpt_nyp_error_message_templates.maximum_js.replace("%%MAXIMUM%%", woocommerce_nyp_format_price(F, woocommerce_nyp_params.currency_format_symbol, !0))) : q = wcpt_nyp_error_message_templates.empty, q) return void alert(q)
                        }
                    }
                    var O = t(".wcpt-quantity input.qty, .wcpt-quantity > select.wcpt-qty-select", i),
                        T = t(".cart .qty", i);
                    if (T.length && (m = T.val()), O.length) {
                        var N = parseFloat(O.val());
                        !isNaN(N) && parseFloat(O.val()) || O.filter("input").first().each(function() {
                            var a = t(this),
                                e = a.attr("data-wcpt-min");
                            a.val(e), R(a.parent("wcpt-quantity")), N = a.val()
                        }), m = N
                    }
                    if (b.payload.products[r] = m, d) {
                        var j = wcpt_get_addons(i);
                        t.isEmptyObject(j) || (b.payload.addons[r] = j)
                    }
                    if (_) {
                        var $ = Z(i);
                        t.isEmptyObject($) || (b.payload.measurement[r] = $)
                    }
                    if (g) {
                        var S = tt(i);
                        S && (b.payload.nyp[r] = S)
                    ...
                    if (s) {
                        var I = i.attr("data-wcpt-variation-id"),
                            P = JSON.parse(i.attr("data-wcpt-variation-attributes")),
                            A = t(".wcpt-select-variation-attribute-term", i);
                        A.length && A.each(function() {
                            var a = t(this),
                                e = a.attr("data-wcpt-attribute"),
                                c = a.val();
                            c && (P[e] = c)
                        }), void 0 === b.payload.variations[r] && (b.payload.variations[r] = {}), b.payload.variations[r][I] = m, b.payload.attributes[I] = P
                    } else if (i.hasClass("wcpt-product-type-variable")) {
                        I = i.data("wcpt_variation_id"), P = i.data("wcpt_attributes");
                        I && (void 0 === b.payload.variations[r] && (b.payload.variations[r] = {}), b.payload.variations[r][I] = m), P && (b.payload.attributes[I] = P)
                    }
                    var W = {
                        action: "wcpt_add_to_cart",
                        "add-to-cart": i.attr("data-wcpt-product-id"),
                        product_id: r,
                        quantity: m
                    };
                    if (d && (t.isEmptyObject(j) || t.extend(W, j)), _) {
                        $ = Z(i);
                        t.isEmptyObject($) || t.extend(W, $)
                    }
                    if (g) {
                        S = tt(i);
                        S && (W.nyp = S)
                    }
                    if ((o || s) && (I && (W.variation_id = I), P && t.extend(W, P)), W.return_notice = "cart_ajax" == c, p || l || o && !n || s && h(P) || d && !b.payload.addons[r] || _ && !b.payload.measurement[r] || g && !b.payload.nyp[r]) return void 0 !== window.wcpt_product_form[r] ? u(window.wcpt_product_form[r], e, W) : (W.action = "wcpt_get_product_form_modal", W.lang = wcpt_i18n.lang, delete W["add-to-cart"], t.ajax({
                        url: wcpt_params.wc_ajax_url.replace("%%endpoint%%", "wcpt_get_product_form_modal"),
                        method: "POST",
                        beforeSend: function() {
                            window.wcpt_modal__last_requested_product_id = r, v()
                        },
                        data: W
                    }).done(function(a) {
                        window.wcpt_product_form[r] = a, r === window.wcpt_modal__last_requested_product_id && (t(".wcpt-product-form-loading-modal").trigger("wcpt_close"), u(a, e, W))
                    })), !1;
                    "cart_ajax" == c ? wcpt_cart(b) : f(e.attr("href"), W)
                }
            }
        }
        ...
        function u(a, e, c) {
            var i = t(a);
            i.appendTo("body"), t("body").addClass("wcpt-modal-on"), g(i, e, c), t("body").trigger("wcpt_product_modal_ready")
        }

        function v() {
            var a = t(t("#tmpl-wcpt-product-form-loading-modal").html());
            t("body").append(a), a.on("wcpt_close", function() {
                a.remove()
            })
        }
        ...
        function f(a, e) {
            var c = t('<form method="POST" action="' + a + '" style="display: none;"></form>');
            t.each(e, function(a, e) {
                if ("action" != a) {
                    var i = t('<input type="hidden" name="' + a + '" value="" />');
                    i.val(e), c.append(i)
                }
            }), c.append('<input type="hidden" name="wcpt_request" value="true" />'), c.appendTo(t("body")).submit()
        }

        function g(a, e, c) {
            var i = e.attr("data-wcpt-link-code"),
                r = "cart_ajax" == i ? "" : e.attr("href");
            a.on("wcpt_close", function() {
                ...
                o.hasClass("variations_form") ? o.wc_variation_form() : o.append('<input name="add-to-cart" type="hidden" value="' + c.product_id + '">'), "object" == typeof WC_PAO ? new WC_PAO.Form(o) : (t.fn.init_addon_totals && o.init_addon_totals(), "object" == typeof wcPaoInitAddonTotals && wcPaoInitAddonTotals.init(o)), "undefined" != typeof wcpt_wc_mc_init_cart && o.each(wcpt_wc_mc_init_cart), void 0 !== jQuery.fn.wc_nyp_form && o.wc_nyp_form(), o.attr("action", r), t(".qty", o).attr("autocomplete", "off"), c && t.each(c, function(t, a) {
                    ...
                    if (e.is("input.qty")) {
                        a = parseFloat(a);
                        var c = e.attr("min") ? parseFloat(e.attr("min")) : 0,
                            i = !!e.attr("max") && parseFloat(e.attr("max"));
                    ...
                    }), a.trigger("wcpt_close")
                });
                var n = wcpt_get_sibling_rows(e.closest(".wcpt-row"));
                n.find(".qty[data-wcpt-return-to-initial=1]").val(0).first().trigger("change")
            })
        }
        ...
        function y(t) {
            if (m(t), !t.find(".wcpt-cart-badge-refresh").length) {
                var a = '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-loader" color="#384047"><line x1="12" y1="2" x2="12" y2="6"></line><line x1="12" y1="18" x2="12" y2="22"></line><line x1="4.93" y1="4.93" x2="7.76" y2="7.76"></line><line x1="16.24" y1="16.24" x2="19.07" y2="19.07"></line><line x1="2" y1="12" x2="6" y2="12"></line><line x1="18" y1="12" x2="22" y2="12"></line><line x1="4.93" y1="19.07" x2="7.76" y2="16.24"></line><line x1="16.24" y1="7.76" x2="19.07" y2="4.93"></line></svg>';
                t.append('<i class="wcpt-cart-badge-refresh">' + a + "</i>")
            }
        }
        ...
        function C(a) {
            var e = t(this),
                c = e.closest(".wcpt-search"),
                i = c.find(".wcpt-search-input"),
                r = c.attr("data-wcpt-table-id"),
                o = t("#wcpt-" + r),
                n = e.closest(".wcpt-nav-modal"),
                s = e.closest(".wcpt-navigation"),
                p = i.val().trim();
            if (query = i.attr("name") + "=" + p, $wrapper = i.closest(".wcpt-search-wrapper"), append = !$wrapper.hasClass("wcpt-search--reset-others"), t(a.target).closest(".wcpt-search-submit").length && "click" == a.type || t(a.target).is(".wcpt-search-input") && "keydown" == a.type && (13 == a.keyCode || 13 == a.which)) {
                ...
                append ? s.trigger("change") : ft(o, query, append, "filter"), n.length && n.trigger("wcpt_close")
            }
        }

        function x(t) {
            var a = !!t.closest(".wcpt-tooltip").length,
                e = !!t.closest(".wcpt-left-sidebar").length;
            return t.hasClass("wcpt-tooltip--open-on-click") || "click" == wcpt_global_tooltip_trigger_mode ? "click" : !a && e ? "click" : "hover"
        }
        ...
        function z(a) {
            var e = t(this);
            if ("hover" === x(e) && !e.hasClass("wcpt-tooltip--open-on-click") && "click" != wcpt_global_tooltip_trigger_mode) {
                var c = e.data("wcpt_hover_intent_clear_timeout");
                c && clearTimeout(c), e.removeClass("wcpt-open")
            }
        }

        function F(a) {
            var e = t(a.target),
                c = ".wcpt-dropdown, .wcpt-tooltip",
                i = "> .wcpt-dropdown-menu, > .wcpt-tooltip-content-wrapper > .wcpt-tooltip-content",
                r = e.closest(c),
                o = r.find(i),
                n = t("body");
            if ("click" === x(r))
                if (r.length) {
                    if (r.length) {
                        if (e.closest(o).length);
                            ...
                            var s = r.parents(c),
                                p = t(".wcpt-left-sidebar  .wcpt-dropdown");
                            n.find(c).not(r.add(s).add(p)).removeClass("wcpt-open"), r.toggleClass("wcpt-open"), r.hasClass("wcpt-open") || r.find(c).removeClass("wcpt-open"), r.hasClass("wcpt-tooltip--popup-enabled") && (r.hasClass("wcpt-open") ? n.addClass("wcpt-tooltip-popup-displayed") : n.removeClass("wcpt-tooltip-popup-displayed"))
                        }
                        O(r)
                    }
                } else e.closest(".wcpt-nav-modal").length || n.find(c).removeClass("wcpt-open")
        }
        ...
        function O(a) {
            ...
            if (a.hasClass("wcpt-tooltip")) {
                ...
                var s = t.extend({}, o[0].getBoundingClientRect()),
                    p = e[0].getBoundingClientRect(),
                    l = t(".frzTbl-table", o).not(".frzTbl-clone-table");
                if (e.closest(l).length) {
                    var d = l.data("freezeTable").el.$frozenColumnsLeft,
                        w = l.data("freezeTable").el.$frozenColumnsRight;
                ...
                if (p.left - 15 < s.left) {
                    var h = 15 + s.left - p.left,
                        f = u / 2 - v;
                    h > f && (h = f), e.css("left", h)
                } else if (p.right + 15 > s.right) {
                    var g = p.right - s.right + 15;
                    f = u / 2 - v;
                    g > f && (g = f), e.css("right", g)
                }
            } else {
                if (c + 30 > r) {
                    e.outerWidth(r - 30);
            ...
            if (a.hasClass("wcpt-tooltip")) {
                var b = a.find("> .wcpt-tooltip-label"),
                    y = (i = b.offset().left, b.outerWidth()),
                    k = t("> .wcpt-tooltip-arrow", e);
                k.css("left", i - e.offset().left + y / 2 + "px")
            }
        }
        ...
        function T(a) {
            var e = t(a.target),
                c = e.closest(".wcpt"),
                i = c.find(".wcpt-navigation");
            if (!e.closest(".wcpt-search-filter-options").length && !e.closest(".wcpt-filter-date-picker").length) {
                if (e.closest(".wcpt-hierarchy").length) {
                    e.prop("checked");
                    if (e.hasClass("wcpt-hr-parent-term")) {
                        var r = "input[type=checkbox], input[type=radio]",
                            o = e.closest("label").siblings(".wcpt-hr-child-terms-wrapper").find(r);
                        o.prop("checked", !1)
                    }
                    var n = e.parents(".wcpt-hr-child-terms-wrapper");
                    n.length && n.each(function() {
                        var a = t(this).siblings("label").find(".wcpt-hr-parent-term");
                        a.prop("checked", !1)
                    })
                }
                if (e.closest(".wcpt-range-filter")) {
                    ...
                    var s = e.attr("data-wcpt-range-min") || "",
                        p = e.attr("data-wcpt-range-max") || "",
                        l = e.closest(".wcpt-range-filter"),
                        d = l.find(".wcpt-range-input-min"),
                        w = l.find(".wcpt-range-input-max"),
                        _ = l.find(".wcpt-range-slider.original");
                    d.val(s), w.val(p), s || (s = _.attr("min")), p || (p = _.attr("max")), _.val(s + "," + p)
                }
                if (!e.closest(".wcpt-search").length && !e.closest(".wcpt-nav-modal").length) {
                    var u = t(this),
                        v = (i = u.add(u.siblings(".wcpt-navigation")), c = i.closest(".wcpt"), c.attr("id").substring(5)),
                        h = i.clone();
                    N(h);
                    var f = t("<form>").append(h).serialize();
                    if (!t(a.target).closest('[data-wcpt-filter="sort_by"]').length) {
                        var g = H(c),
                            m = t(".wcpt-heading.wcpt-sortable:visible", g),
                            b = m.filter(function() {
                                return t(this).find(".wcpt-sorting-icons.wcpt-sorting-asc, .wcpt-sorting-icons.wcpt-sorting-desc").length
                            });
                        if (b.length) {
                            var y = b.attr("data-wcpt-column-index"),
                                k = b.find(".wcpt-sorting-icons.wcpt-sorting-asc").length ? "ASC" : "DESC";
                            f += "&" + v + "_orderby=column_" + y + "&" + v + "_order=" + k
                        }
                    }!i.find(".wcpt-apply").length || t(a.target).hasClass("wcpt-navigation") ? ft(c, f, !1, "filter") : j(i)
                }
            }
        }
        ...
        function j(a) {
            t(".wcpt-filter", a.filter(".wcpt-header")).each(function() {
                var a = t(this),
                    e = a.attr("data-wcpt-filter"),
                    c = a.closest(".wcpt-filter"),
                    i = a.attr("data-wcpt-heading_format__op_selected"),
                    r = a.find("input[type=radio]").length || a.hasClass("wcpt-range-filter"),
                    o = a.find("input[type=checkbox]").length,
                    n = a.find("input[type=radio]:checked"),
                    s = a.find("input[type=checkbox]:checked"),
                    p = s.length,
                    l = a.find(".wcpt-active-count"),
                    d = !1,
                    w = "",
                    _ = t(".wcpt-range-options-main", c),
                    u = t(".wcpt-range-options-main .wcpt-range-input-min", c),
                    v = t(".wcpt-range-options-main .wcpt-range-input-max", c);
                if (!a.hasClass("wcpt-options-row") && -1 != t.inArray(e, ["custom_field", "attribute", "category", "taxonomy", "price_range", "rating", "sort_by", "results_per_page", "on_sale", "availability"]))
                    if (p || n.val() && !n.closest(".wcpt-default-option").length || _.length && (u.val() != u.attr("min") || v.val() != v.attr("max")) ? a.closest(".wcpt-filter").addClass("wcpt-filter--active") : a.closest(".wcpt-filter").removeClass("wcpt-filter--active"), r && "only_heading" !== i) {
                        if (a.find(".wcpt-radio-op-selected__heading-append").remove(), n.length && n.attr("value") ? (a.addClass("wcpt-radio-op-selected"), w = n.next()[0].outerHTML, d = !0) : a.removeClass("wcpt-radio-op-selected"), !n.length && "price_range" == e) {
                            var h = wcpt_params.currency_symbol + t(".wcpt-range-input-min", a).val() || 0,
                                f = wcpt_params.currency_symbol + t(".wcpt-range-input-max", a).val() || 0;
                            w = "<span>" + h + " - " + f + "<span>", t(".wcpt-range-input-min", a).val() == t(".wcpt-range-input-min", a).attr("min") && t(".wcpt-range-input-max", a).val() == t(".wcpt-range-input-max", a).attr("max") || (a.addClass("wcpt-radio-op-selected"), d = !0)
                        }
                        if (!n.length && "custom_field" == e) {
                            h = t(".wcpt-range-input-min", a).val() || 0, f = t(".wcpt-range-input-max", a).val() || 0;
                            w = "<span>" + h + " - " + f + "<span>", h == t(".wcpt-range-input-min", a).attr("min") && f == t(".wcpt-range-input-max", a).attr("max") || (a.addClass("wcpt-radio-op-selected"), d = !0)
                        }
                        d && a.find(".wcpt-dropdown-label").append('<div class="wcpt-radio-op-selected__heading-append">' + w + "</div>")
                    } else o && (l.remove(), p && (l = t('<span class="wcpt-active-count" style="margin-left: 6px">' + p + "</span>"), t(".wcpt-filter-heading .wcpt-dropdown-label", a).after(l)))
            })
        }

        function $(a, e) {
            t("body").trigger("wcpt_before_ajax_container_replace", {
                response: a,
                $container: e
            });
            var c = t(a);
            ...
            var i = e.attr("data-wcpt-sc-attrs"),
                r = i && "{}" !== i ? JSON.parse(i) : {},
                o = {
            ...
            if (r._auto_scroll || r[n + "_auto_scroll"]) {
                o = o[n];
                isNaN(o) && ("string" == typeof o ? o = t(o).height() : "object" == typeof o && (o = o.height())), t("html, body").animate({
                    scrollTop: e.offset().top - parseFloat(o)
                }, 200)
            }
        }
        ...
        function I(a) {
            var e = "laptop",
                c = a.find(".wcpt-table-scroll-wrapper-outer:visible");
        ...
        function P(a) {
            var e = t(a.target).closest(".wcpt-rn-button"),
                c = e.attr("data-wcpt-modal"),
                i = e.closest(".wcpt"),
                r = i.attr("id"),
                o = t(i.find(".wcpt-nav-modal-tpl").html()),
                n = i.find(".wcpt-filter").not('[data-wcpt-filter="sort_by"]'),
                s = i.find(".wcpt-search-wrapper"),
                p = i.find('[data-wcpt-filter="sort_by"].wcpt-filter'),
                l = {};
            t(".wcpt-nm-sort-placeholder", o).replaceWith(p.clone()), t(".wcpt-nm-filters-placeholder", o).replaceWith(s.clone().add(n.clone())), t('.wcpt-nm-sort-placeholder [data-wcpt-filter="sort_by"]', o).addClass("wcpt-open"), "sort" == c ? o.addClass("wcpt-show-sort").removeClass("wcpt-show-filters") : o.addClass("wcpt-show-filters").removeClass("wcpt-show-sort"), i.find("input[type=radio]:checked").each(function() {
                ...
                var a = o.clone();
                N(a);
                var e = t("<form>").append(a).serialize(),
                    c = t("#" + r);
                t("body").trigger("wcpt-nav-modal-off").removeClass("wcpt-nav-modal-on"), o.remove(), window.scroll(null, wcpt_nav_modal_scroll), ft(c, e, !1, "filter")
            }), o.filter(".wcpt-show-sort").on("change", function() {
                var a = t("<form>").append(o.clone()).serialize(),
                    e = t("#" + r);
                o.trigger("wcpt_close"), ft(e, a, !1, "filter")
        ...
        function W(t, a, e) {
            var c = t.originalEvent.clientX + 40,
                i = t.originalEvent.clientY,
                r = "right";
            a.css({
                left: c,
                top: i
            });
            var o = a.get(0).getBoundingClientRect(),
                n = window.innerWidth || document.documentElement.clientWidth,
                s = window.innerHeight || document.documentElement.clientHeight;
            o.right > n && (r = "left"), "left" == r && (c = e.get(0).getBoundingClientRect().left - 40 - o.width), o.top < 0 ? i = 0 + .25 * o.height : o.bottom > s && (i -= o.bottom - s), a.css({
                left: c,
                top: i
            })
        }
        ...
        function L() {
            t(".wcpt-offset-zoom-container").remove(), ht.off("mousemove.wcpt_offset_zoom")
        }

        function E(a) {
            if (!window.wcpt_form_reset_flag) {
                var e = JSON.parse(a.attr("data-product_variations")),
                    c = a.closest(".wcpt-row"),
                    i = t(".variation_id", a),
                    r = {},
                    o = {},
                    n = i.val();
        ...
        function J(a) {
            t(a).filter(".wcpt-product-type-variable").each(function() {
                var a = t(this),
                    e = t(".wcpt-select-variation-dropdown", a),
                    c = t(".wcpt-variation-radio", a),
                    i = t(".variations_form", a),
                    r = e.add(c).add(i);
                r.length && a.data("wcpt_variation_ops", !0), i.length ? i.each(function() {
                    var a = t(this);
                    setTimeout(function() {
        ...
        function R(a) {
            a.each(function() {
                var a = t(this),
                    e = a.children(".wcpt-minus"),
                    c = a.children(".wcpt-plus"),
                    i = a.find(".qty"),
                    r = i.attr("data-wcpt-initial-value"),
                    o = i.attr("min") ? parseFloat(i.attr("min")) : 1,
                    n = !!i.attr("max") && parseFloat(i.attr("max")),
                    s = i.attr("step") ? parseFloat(i.attr("step")) : 1,
                    p = parseFloat(i.val());
        ...
        function M(a, e) {
            var c = wcpt_get_sibling_rows(a),
                i = c.find(".qty").eq(0),
                r = i.length ? parseFloat(i.val() ? i.val() : 0) : 1,
                o = t(".wcpt-total", c),
                n = t(".wcpt-cart-checkbox ", c),
                s = parseFloat(o.attr("data-wcpt-in-cart-total")),
                p = c.attr("data-wcpt-price") ? parseFloat(c.attr("data-wcpt-price")) : 0,
                l = 0;
            if (e && (r = e), c.hasClass("wcpt-product-type-variable") && (p = c.data("wcpt_variation_found") && c.data("wcpt_variation") && c.data("wcpt_variation").display_price ? K(c.data("wcpt_variation").display_price) : 0), a.hasClass("wcpt-product-has-name-your-price")) {
            ...
            l = (r * p).toFixed(2), n.length && !c.data("wcpt_checked") && "min" !== i.attr("data-wcpt-initial-value") && (l = 0), o.each(function() {
                var a = t(this),
                    e = l;
                a.hasClass("wcpt-total--include-total-in-cart") && (e += s), parseFloat(e) ? a.removeClass("wcpt-total--empty").find(".wcpt-amount").text(G(e)) : a.addClass("wcpt-total--empty")
        ...
        function Q() {
            ...
            if (a.length) a.removeClass("wcpt-hide");
            else {
            ...
            if (t(".wcpt-table:visible").each(function() {
                ...
                c.each(function() {
                    var a = t(this),
                        e = t(".qty, .wcpt-qty-select", a).first(),
                        c = e.length ? parseFloat(e.val()) : 1,
                    ...
                    wcpt_qty: i,
                    wcpt_cost: r
                }).find(".wcpt-total-selected").text(i).end().find(".wcpt-total-selected-cost").text(G(r)), a.trigger("wcpt_checkbox_trigger_updating").show().trigger("wcpt_checkbox_trigger_updated")
            } else a.hide()
        }
        ...
        function B() {
            ...
            setTimeout(function() {
                var e = t(a),
                    c = e.closest(".wcpt"),
                    i = H(c),
                    r = i.data("wcpt_checked_rows") ? i.data("wcpt_checked_rows") : t();
                if ($add_checked = t(".wcpt-add-selected:visible", c), $add_checked.removeClass("wcpt-add-selected--unselected wcpt-add-selected--single-item-selected"), r.length) {
                    var o = 0,
                        n = 0;
                    r.each(function() {
                        var a = t(this),
                            e = t(".qty, .wcpt-qty-select", a).first(),
                            c = e.length ? parseFloat(e.val()) : 1;
                        isNaN(c) || (o = (1e12 * c + 1e12 * o) / 1e12), a.data("wcpt-total") || M(wcpt_get_sibling_rows(a));
                        var i = a.data("wcpt-total");
                        n = (1e12 * n + 1e12 * i) / 1e12
                    }), t(".wcpt-total-selected", $add_checked).text(o), t(".wcpt-total-selected-cost .wcpt-amount", $add_checked).text(G(n)), 1 == o && $add_checked.addClass("wcpt-add-selected--single-item-selected")
                } else $add_checked.addClass("wcpt-add-selected--unselected")
            }, 100)
        }

        function G(t) {
            t = parseFloat(t), t = t !== parseInt(t) ? parseFloat(t).toFixed(wcpt_params.price_decimals) : parseInt(t), t = (t + "").replace(".", wcpt_params.price_decimal_separator);
            var a = t.split(wcpt_params.price_decimal_separator);
        ...
        function K(t) {
            return t = t.toString(), t = t.replace(wcpt_params.price_thousand_separator, ""), t = t.replace(wcpt_params.price_decimal_separator, "."), parseFloat(t)
        }

        function V(t) {
            return t || "0" === t || 0 === t ? wcpt_params.price_format.replace("%1$s", wcpt_params.currency_symbol).replace("%2$s", G(t)) : ""
        }

        function Y(t) {
            var a = n(".wcpt-add-selected.wcpt-duplicate-enabled:visible", t),
                e = n(".wcpt-pagination.wcpt-device-laptop", t);
        ...
        function X() {
            ...
            p.each(function() {
                var a = t(this);
                $table_checked_rows = a.data("wcpt_checked_rows") ? a.data("wcpt_checked_rows") : t(),
                    s = s.add($table_checked_rows)
            }), s.each(function() {
                var a = t(this),
                    s = a.attr("data-wcpt-product-id"),
                    p = !1,
                    l = !1,
                    d = t(".qty, .wcpt-qty-select", a).first(),
                ...
                p && (c[s] || (c[s] = {}), c[s][p] || (c[s][p] = w), l && (i[p] = l)), a.hasClass("wcpt-product-has-addons") && (r[s] = wcpt_get_addons(a)), a.hasClass("wcpt-product-has-measurement") && (o[s] = Z(a)), a.hasClass("wcpt-product-has-name-your-price") && (n[s] = tt(a))
            }), s.trigger("_wcpt_checkbox_change", !1);
            var d = {
                products: e,
                addons: r,
                measurement: o,
        ...
        function Z(a) {
            var e = t(".wcpt-add-to-cart-wrapper form #price_calculator", wcpt_get_sibling_rows(a)),
                c = {};
        ...
        function et(a) {
            if (a.data("wcpt_sc_attrs").dynamic_filters_lazy_load && (a.data("wcpt_sc_attrs").dynamic_recount || a.data("wcpt_sc_attrs").dynamic_hide_filters)) {
                ...
                if (e && c) {
                    var i = JSON.parse(c),
                        r = ["category", "attribute", "availability", "on_sale", "taxonomy"];
                    t(".wcpt-filter", a).each(function() {
                        var a = t(this),
                            c = a.attr("data-wcpt-filter"); - 1 !== t.inArray(c, r) && ct(a, e, i)
                    })
                }
            }
        }
        ...
        function ct(a, e, c) {
            var i = a.attr("data-wcpt-filter"),
                r = a.attr("data-wcpt-taxonomy"),
                o = [],
                n = a.closest(".wcpt");
            t.each(c, function(t, a) {
                ...
                method: "GET",
                data: {
                    wcpt__dynamic_filter__key: e,
                    wcpt__dynamic_filter__options: o
                },
                success: function(c) {
                    c = JSON.parse(c);
                    var o = t("style#" + e, n),
                    ...
                    sc_attrs = n.attr("data-wcpt-sc-attrs"), sc_attrs && sc_attrs.length > 2 && (sc_attrs = JSON.parse(sc_attrs), sc_attrs.dynamic_recount && (p = !0)), p && t.each(c.options, function(e, c) {
                        var i = '<span class="wcpt-count">(' + c.count + ")</span>",
                            r = t('label[data-wcpt-value="' + c.value + '"]', a),
                            o = r.children(".wcpt-icon"),
                            n = t(".wcpt-count", r);
                        n.remove(), o.length ? o.before(i) : r.append(i)
        ...
        function it() {
            ...
            return !(!wcpt_params.cart_widget_enabled_site_wide && !t(".wcpt").length) && (wcpt_params.cart_widget_include_urls.trim() && (i = wcpt_params.cart_widget_include_urls.trim().replace(/\r\n/g, "\n").split("\n")), wcpt_params.cart_widget_exclude_urls.trim() && (r = wcpt_params.cart_widget_exclude_urls.trim().replace(/\r\n/g, "\n").split("\n")), !(i.length && (e = !1, t.each(i, function(t, c) {
                if (c = c.trim(), 0 === c.indexOf(o) && (c = c.substring(o.length, c.length)), "/" != c.trim())
                    if ("/*" != c.trim())
                        if (c = c.replace(/(^\s*\/)|(\/\s*$)/g, ""), "*" === c.substr(-1)) {
                            var i = 1;
                ...
                if (e = e.trim(), 0 === e.indexOf(o) && (e = e.substring(o.length, e.length)), "/" != e.trim())
                    if ("/*" != e.trim())
                        if (e = e.replace(/(^\s*\/)|(\/\s*$)/g, ""), "*" === e.substr(-1)) {
                            var i = 1;
        ...
        function rt(a) {
            var e = a.parent(),
                c = a.val(),
                i = a.attr("data-wcpt-nyp-minimum-price"),
                r = a.attr("data-wcpt-nyp-maximum-price"),
                o = "",
                n = "",
                s = a.closest(".wcpt-row"),
                p = s.data("wcpt_checked");
            c && i && parseFloat(c) < parseFloat(i) || p && !c && i ? (e.addClass("wcpt-name-your-price-wrapper--input-error wcpt-name-your-price-wrapper--input-error--min-price"), n = t(".wcpt-name-your-price-input-error-message--min-price", e), o = n.attr("data-wcpt-error-message-template"), n.text(o.replace("[min]", G(i)))) : c && r && parseFloat(c) > parseFloat(r) ? (e.addClass("wcpt-name-your-price-wrapper--input-error wcpt-name-your-price-wrapper--input-error--max-price"), n = t(".wcpt-name-your-price-input-error-message--max-price", e), o = n.attr("data-wcpt-error-message-template"), n.text(o.replace("[max]", G(r)))) : e.removeClass("wcpt-name-your-price-wrapper--input-error wcpt-name-your-price-wrapper--input-error--min-price wcpt-name-your-price-wrapper--input-error--max-price")
        }
        ...
        function nt(a) {
            if (WavePlayer.persistentTrack && WavePlayer.instances.length) {
                ...
                if (t.each(WavePlayer.instances, function(a, c) {
                        var i = t(c.node);
                        if (i.is(":visible") && i.parent().hasClass("wcpt-waveplayer-container")) {
                            var r = i.closest(".wcpt-row");
                            r.length && t.each(c.tracks, function(t, a) {
        ...
        function st() {
            var a = t(this),
                e = a.attr("data-wcpt-waveplayer-active-row-background-color"),
            ...
            r.addClass("wcpt-waveplayer-active").css({
                background: e || "",
                outline: i + " solid " + c
            }), t(".wcpt-row").not(r).removeClass("wcpt-waveplayer-active").css({
                background: "",
                outline: ""
            })
        }
        ...
        function lt(a) {
            void 0 === a && (a = t("body"));
            var e = a.is(".wcpt-afrfqbt") ? a : t(".wcpt-afrfqbt", wcpt_util.get_uninit_rows(a));
            e.each(function() {
                var a = t(this),
                    e = a.closest(".wcpt-row"),
                    c = !1,
                    i = e.attr("data-wcpt-type"),
        ...
        var dt = ".wcpt-button-cart_ajax, .wcpt-button-cart_redirect, .wcpt-button-cart_refresh, .wcpt-button-cart_checkout";
        window.wcpt_cache = {
            data: {},
            remove: function(t) {
        ...
        }, window.wcpt_current_device = a(), t(window).on("resize", function() {
            window.wcpt_cache.data = {}, window.wcpt_previous_device = window.wcpt_current_device, window.wcpt_current_device = a(), window.wcpt_previous_device !== window.wcpt_current_device && t(window).trigger("wcpt_device_change", {
            ...
            var a = t(this),
                e = a.closest(".wcpt"),
                c = a.closest(".frzTbl-content-wrapper").siblings(".frzTbl-scroll-overlay"),
                i = c[0].scrollLeft;
            t("body").one("after_freeze_table_build", "#" + e.attr("id") + " .frzTbl-table", function(t, a) {
                a.el.$scrollOverlay[0].scrollLeft = i
            })
        }), t("body").on("wcpt_layout", ".wcpt", function(e, c) {
            var i = t(this),
                r = i.find(".wcpt-table-scroll-wrapper:visible"),
                o = i.attr("data-wcpt-table-id"),
            ...
            if (t(">.wcpt-device-view-loading-icon", r).length) {
                var s = window.location.href,
                    ...
                    d = "",
                    w = a();
                if (p && (s = s.replace(p, "")), l) {
                    var _ = "&*" + o + "_device=(laptop|phone|tablet)";
                    re = new RegExp(_, "gm"), s = (s.replace(re, "") + "&" + o + "_device=" + w).replace("?&", "?")
                } else s = s + "?" + o + "_device=" + w;
                return p && (s += p), -1 !== i.attr("data-wcpt-sc-attrs").indexOf("_only_loop") ? void(window.location = s) : (d = s.substr(s.indexOf("?") + 1), p && (d = d.replace(p, "")), void ft(i, d, !1, "device_view"))
            }
            if (!wcpt_is_module_disabled("freeze-table", i) && !wcpt_util.get_freeze_table(i)) {
                ...
                ["laptop", "tablet", "phone"].forEach(a => {
                    var e = n[`${a}_freeze_left`],
                        c = n[`${a}_freeze_right`],
                        i = n[`${a}_freeze_heading`],
                        r = n[`${a}_scroll_offset`],
                        o = n.grab_and_scroll,
                        s = n[`${a}_table_width`],
                        p = {
                            left: e ? parseInt(e) : 0,
                    ...
                    "laptop" == a ? t.extend(u, p) : u.breakpoint[wcpt_params.breakpoints[a]] = p
                }), v.freezeTable(u, c.source)
            }
            w = a();
            var h = t(".wcpt-left-sidebar, .wcpt-was-left-sidebar", i).not(".wcpt-nav-modal .wcpt-navigation");
            "laptop" == w && h.hasClass("wcpt-was-left-sidebar") ? h.removeClass("wcpt-header wcpt-was-left-sidebar").addClass("wcpt-left-sidebar") : "laptop" == w || h.hasClass("wcpt-was-left-sidebar") || h.removeClass("wcpt-left-sidebar").addClass("wcpt-header wcpt-was-left-sidebar"), t(".wcpt-was-left-sidebar .wcpt-dropdown", i).removeClass("wcpt-open");
            v = H(i);
            if (v.data("wcpt_checked_rows") && v.data("wcpt_checked_rows").length) {
                var f = t(".wcpt-row", v);
                f.each(function() {
                    var a = t(this),
                        e = !!a.data("wcpt_checked");
        ...
        t(window).on("orientationchange", function(t) {
            !0
        }), t("body").on("click", ".wcpt-button", _), t("body").on("click", ".wcpt-search-submit", C), t("body").on("keydown", ".wcpt-search-input", C), t("body").on("click", ".wcpt-search-clear", function(a) {
            var e = t(this),
                c = e.closest(".wcpt-search"),
                i = c.find(".wcpt-search-input"),
                r = c.attr("data-wcpt-table-id"),
                ...
                s = "&" + i.attr("name") + "=",
                p = !0;
            i.val(""), n.length ? t(".wcpt-nm-apply").click() : (ft(o, s, p, "filter"), n.length && n.trigger("wcpt_close"))
        }), "laptop" !== wcpt_params.initial_device && t("body").on("click", ".wcpt-button[download]", function(a) {
            a.preventDefault();
            var e = t(this),
                c = e.attr("href");
            c && window.open(c, "_blank", !1)
        ...
        var vt = ".wcpt-dropdown, .wcpt-tooltip",
            ht = t("body");
        ht.on("mouseenter", vt, q), ht.on("mouseleave", vt, z), ht.on("click", F), t("body").on("click mouseover", ".wcpt-tooltip-content", function() {
            var a = t(this),
                e = a.closest(".wcpt-tooltip");
            e.hasClass("wcpt-tooltip--hover-disabled") && e.removeClass("wcpt-open")
        ...
        }), t("body").on("change", ".wcpt-navigation", T), t("body").on("keyup", ".wcpt-range-input-min, .wcpt-range-input-max", function(a) {
            var e = t(this),
                c = e.closest(".wcpt-navigation"),
                i = a.keyCode ? a.keyCode : a.which;
            13 == i && c.trigger("change")
        }), t("body").on("click", ".wcpt-range-submit-button", function(a) {
            var e = t(this),
                c = e.closest(".wcpt-range-options-main"),
                i = t(".wcpt-range-input-min", c),
                r = t(".wcpt-range-input-max", c),
            ...
            var e = t(this),
                c = e.closest('[data-wcpt-filter="date_picker"]'),
                i = t(".wcpt-filter-date-picker--start-date", c),
                r = t(".wcpt-filter-date-picker--end-date", c),
                o = e.closest(".wcpt-navigation");
            if (i.val() && r.val()) {
                var n = new Date(i.val()),
                    s = new Date(r.val());
                if (n > s) {
                    var p = i.val(),
                        l = r.val();
            ...
            var c = t(this),
                i = t(a.target);
            if (i.closest(".wcpt-dropdown-menu")) i.closest(".wcpt-dropdown-option");
            else !1;
            var r = c.closest(".wcpt"),
                o = c.attr("data-wcpt-filter"),
                n = t("> .wcpt-navigation", r),
                s = t();
            if ("search" == o) {
                var p = c.attr("data-wcpt-search-name");
                s = t('.wcpt-search-input[name="' + p + '"]', n)
            } else if ("attribute" == o || "category" == o || "taxonomy" == o) {
                var l = c.attr("data-wcpt-taxonomy"),
                    d = c.attr("data-wcpt-value");
                s = n.find('.wcpt-filter[data-wcpt-filter="' + o + '"][data-wcpt-taxonomy="' + l + '"]').find('input[value="' + d + '"]')
            } else if ("custom_field" == o) {
                var w = c.attr("data-wcpt-meta-key"),
                    _ = c.attr("data-wcpt-value"),
                    u = n.find('.wcpt-filter[data-wcpt-filter="' + o + '"][data-wcpt-meta-key="' + w + '"]');
                s = u.hasClass("wcpt-range-filter") ? u.find("input") : n.find('.wcpt-filter[data-wcpt-filter="' + o + '"][data-wcpt-meta-key="' + w + '"]').find('input[value="' + _ + '"]')
            } else if ("price_range" == o) s = n.find('.wcpt-filter[data-wcpt-filter="' + o + '"]').find("input");
            else if ("search" == o) s = n.find('input[type=search][data-wcpt-value="' + e(c.attr("data-wcpt-value")) + '"]');
            else if ("rating" == o) s = n.find('.wcpt-filter[data-wcpt-filter="rating"]').find("input");
            else if ("date_picker" == o) {
                var v = c.attr("data-wcpt-value");
                s = n.find('.wcpt-filter[data-wcpt-filter="date_picker"]').find('input[value="' + v + '"]')
            } else _ = c.attr("data-wcpt-value"), s = n.find('.wcpt-filter[data-wcpt-filter="' + o + '"]').find('input[value="' + _ + '"]');
            s.filter(":input[type=checkbox], :input[type=radio]").prop("checked", !1).closest("label.wcpt-active").removeClass("wcpt-active"), s.filter(":input[type=text], :input[type=number], :input[type=search], :input[type=date]").val(""), n.first().trigger("change"), c.siblings(".wcpt-clear-filter").length ? c.remove() : c.closest(".wcpt-clear-filters-wrapper").remove()
        }), t("body").on("click", ".wcpt-clear-filters, .wcpt-clear-all-filters, .wcpt-reset", function(a) {
            a.preventDefault();
            var e = t(this),
                c = e.closest(".wcpt"),
                i = "";
            e.hasClass("wcpt-disabled") || ft(c, i, !1, "filter")
        }), window.wcpt_column_heading_sort_handler = function() {
            var a = t(this),
                e = a.find(".wcpt-sorting-icons");
            if (e.length) {
                var c = e.hasClass("wcpt-sorting-asc") ? "desc" : "asc",
                    i = a.attr("data-wcpt-column-index"),
                    r = a.closest(".wcpt"),
                ...
                var s = o + "_paged=1&" + o + "_orderby=column_" + i + "&" + o + "_order=" + c + "&" + o + "_device=" + n;
                ft(r, s, !0, !1)
            }
            ...
            var e = t(this),
                c = e.closest(".wcpt"),
                i = wcpt_util.get_table_id(c),
                r = e.attr("href"),
                o = r.indexOf("?"),
                n = -1 != o && wcpt_util.parse_query_string(r.slice(o + 1)),
                s = n ? n[i + "_paged"] : 1,
                p = i + "_paged=" + s;
            append = !0, ft(c, p, append, "paginate")
        });
        var ft = window.wcpt_attempt_ajax = ((t, a, e, c) => {
                var i = gt(t, a, e, c);
                mt(t, i, c, $)
            }),
            gt = window.wcpt_build_ajax_query_string = ((a, e, c, i) => {
                var r = a.attr("data-wcpt-table-id");
                if (void 0 === i) throw "WCPT: Define AJAX purpose";
                var o = "",
                    n = a.attr("data-wcpt-query-string");
                ...
                var l = I(a);
                p = wcpt_util.parse_query_string(o);
                p[r + "_device"] !== l && (o += "&" + r + "_device=" + l);
                var d = S(a),
                    w = e ? wcpt_util.parse_query_string(e) : {},
                    _ = n ? wcpt_util.parse_query_string(n.substring(1)) : {},
                    u = d.search_orderby ? "search_orderby" : "relevance";
                if (search_order = d.search_order ? "search_order" : "", t.each(w, function(t, a) {
                    ...
                    var v = wcpt_params.shop_url.indexOf("?lang="); - 1 !== v && -1 !== o.indexOf("lang=") && (wcpt_params.shop_url = wcpt_params.shop_url.substring(0, v)), o = -1 == wcpt_params.shop_url.indexOf("?") ? wcpt_params.shop_url + o : wcpt_params.shop_url + "&" + o.slice(1), o += "&" + wcpt_params.shop_table_id + "_device="
                }
            ...
            mt = window.wcpt_fetch_markup_and_apply_callback = ((a, e, c, i) => {
                function o(t) {
                    r(t)
                }
                var n = a.attr("data-wcpt-table-id"),
                    s = wcpt_util.get_sc_attrs(a),
                    p = wcpt_params.wc_ajax_url.replace("%%endpoint%%", "wcpt_ajax") + "&" + e.slice(1),
                    l = {
                        id: n
                    };
                if (s.form_mode || s.disable_ajax && "false" !== s.disable_ajax) window.location = e;
                else {
                    var d = "refresh_table" !== c && "undefined" == typeof WavePlayer;
                    if (d && window.wcpt_cache.exist(e)) return i(window.wcpt_cache.get(e), a), void o(a);
                    t.ajax({
                        url: p,
                        method: "GET",
                        beforeSend: function() {
                        ...
                        t && -1 !== t.indexOf("wcpt-table") ? (window.wcpt_cache.set(e, t), i(window.wcpt_cache.get(e), a), o(a)) : console.log("wcpt notice: query fail"), a.removeClass("wcpt-loading")
                    })
                }
            });
        if (t("body").on("click", ".wcpt-modal, .wcpt-close-modal", function(a) {
                var e = t(a.target),
                    c = t(this).closest(".wcpt-modal");
                ...
                t.each(a, function(t, a) {
                    ...
                    var a = t(this),
                        ...
                        i = e[c] ? e[c] : 0,
                        r = a.find(".wcpt-cart-badge-number");
                    a.find(".wcpt-remove");
                    a.attr("data-wcpt-in-cart", i), i ? k(i, r.closest(".wcpt-button")) : r.text("")
                })
                ...
                var e = t(this);
                return e.closest(".wcpt-accordion").toggleClass("wcpt-ac-open"), a.stopPropagation(), !1
            }), t("body").on("wcpt_close", ".wcpt-nav-modal", function() {
                var a = t(this),
                    e = a.attr("data-wcpt-table-id");
                t("#wcpt-" + e);
                ...
                var a = t(this),
                    e = a.closest(".wcpt-toggle");
                a.closest(".wcpt-table");
                e.toggleClass(" wcpt-tg-on wcpt-tg-off ")
            }), t("body").on("click", ".wcpt-rn-filter, .wcpt-rn-sort", P), t("body").on("click", ".wcpt-accordion-heading", function() {
                ...
                var e = t(this),
                    c = e.data("wcpt_photoswipe");
                if (window.innerWidth < 720 && c) {
                    var i = t(a.target);
                    i.closest(".pswp__button").length || c.close()
                }
            }), t("body").on("click", ".wcpt-gallery__item", function() {
                var a = t(this),
                    e = parseInt(a.attr("data-wcpt-gallery-item")),
                    c = a.closest(".wcpt-gallery");
                c.hasClass("wcpt-gallery--include-featured") || (e += 1), A(c, e)
            }), t("body").on("click", ".wcpt-gallery a", function(a) {
                a.preventDefault();
                var e = t(this),
                    c = e.closest(".wcpt-gallery");
                A(c)
                ...
                if (!a.closest(".wcpt").hasClass("wcpt-quick-view-trigger--product-image") || a.closest(".wcpt-row").hasClass("wcpt-quick-view-trigger__disabled-for-product")) {
                    var e = 0,
                        c = w(a),
                        i = a.attr("data-wcpt-lightbox"),
                        r = JSON.parse(a.attr("data-wcpt-photoswipe-items")),
                        o = !1;
                    if ("variable" === c.attr("data-wcpt-type") && c.data("wcpt_variation_selected")) {
                        var n = c.data("wcpt_variation"),
                            s = (i = n.image.full_src, !1);
                    ...
                    if (!A(a, e, o)) {
                        var p = t('<div class="wcpt-lightbox-screen"><div class="wcpt-lightbox-loader"></div><div class="wcpt-lightbox-close"></div><img class="wcpt-lightbox-image" src="' + i + '"></div>');
                        t("body").append(p), p.on("click ", function() {
                            p.remove()
                        })
                    }
                }
                ...
                var e = t(this),
                    c = e.attr("data-wcpt-offset-zoom-image-src"),
                    ...
                    r = e.closest(".wcpt");
                e.closest(".frzTbl--grab-and-scroll--grabbing").length || (L(), r.append(i).on("mousemove.wcpt_offset_zoom", function(t) {
                    W(t, i, e)
                }), setTimeout(function() {
                    i.addClass("wcpt-offset-zoom-container--fade-in")
                }, 50), e.on("mouseleave", L))
            }), t("body").on("touchstart", function() {
                t("body").off("mouseenter.wcpt_offset_zoom")
            }), t("body").on("click", ".wcpt-variation-radio", function(a) {
                var e = t(this),
                    c = e.closest(".wcpt-select-variation"),
                    i = e.closest(".wcpt-row");
                ...
                var a = t(this),
                    e = t('.wcpt-variation-radio[name="' + t(this).attr("name") + '"]').not(t(this)),
                ...
                var c = w(t(this)),
                    i = c.find(".wcpt-select-variation-dropdown");
                if (i.val(e.variation_id ? e.variation_id : ""), c.find('.wcpt-variation-radio[value="' + e.variation_id + '"]').prop("checked", !0), c.find(".variations_form").each(function() {
                    ...
                    }), c.data("wcpt_variation", e.variation), c.data("wcpt_variation_id", e.variation_id), c.data("wcpt_complete_match", e.complete_match), c.data("wcpt_attributes", e.attributes), c.data("wcpt_variation_found", e.variation_found), c.data("wcpt_variation_selected", e.variation_selected), c.data("wcpt_variation_available", e.variation_available), c.data("wcpt_variation_qty", e.variation_qty), M(c), B.call(c.get(0)), !e.variation_selected) {
                    var r = c.find('[data-wcpt-link-code^="cart"]');
                    (c.find(".wcpt-add-to-cart-wrapper").length || i.length || c.find(".wcpt-variation-radio").length) && m(r, "wcpt-no-variation-selected"), c.hasClass("wcpt-all-variations-out-of-stock") ? m(r, "wcpt-all-variations-out-of-stock") : b(r, "wcpt-all-variations-out-of-stock"), c.first().trigger("_wcpt_checkbox_change", !1);
                    var o = c.find(".wcpt-quantity input[type=number].qty");
                    o.length && o.each(function() {
                        var a = t(this),
                            e = a.attr("data-wcpt-initial-value"),
                            c = a.attr("min") ? a.attr("min") : 1,
                            i = "";
                        i = "min" == e ? c : "0" === e ? 0 : "", "min" === e && a.attr("data-wcpt-reset-on-variation-change") && (i = c), a.attr({
                            ...
                            step: "",
                            value: i
                        }), a.val(i), R(a.closest(".wcpt-quantity"))
                    });
                    var n = t(".wcpt-product-image-wrapper", c),
                        s = t(".wcpt-product-image-wrapper > img:not(.wcpt-product-image-on-hover)", c),
                        p = U(c);
                    n.length && (p.data("wcpt_default_image") ? s.replaceWith(p.data("wcpt_default_image")) : s[0] ? p.data("wcpt_default_image", s[0].outerHTML) : D(n), n.hasClass("wcpt-lightbox-enabled") && (n.attr("data-wcpt-lightbox--original") ? n.attr("data-wcpt-lightbox", n.attr("data-wcpt-lightbox--original")) : n.attr("data-wcpt-lightbox--original", n.attr("data-wcpt-lightbox"))), n.hasClass("wcpt-product-image-wrapper--offset-zoom-enabled") && (n.attr("data-wcpt-offset-zoom-image-src--original") ? n.attr("data-wcpt-offset-zoom-image-src", n.attr("data-wcpt-offset-zoom-image-src--original")) : n.attr("data-wcpt-offset-zoom-image-src--original", n.attr("data-wcpt-offset-zoom-image-src")))), c.find(".wcpt-sku").each(function() {
                        var a = t(this),
                            e = a.attr("data-wcpt-sku");
                        a.text(e)
                    }), c.find(".wcpt-product-id").each(function() {
                        var a = t(this),
                            e = a.attr("data-wcpt-product-id");
                        a.text(e)
                    }), c.filter(".wcpt-product-type-variable").find(".wcpt-price.wcpt-variable-switch").each(function() {
                        var a = t(this),
                            e = a.attr("data-wcpt-element-id"),
                            c = a.attr("data-wcpt-variable-template"),
                            i = t(t("[data-wcpt-element-id=" + e + "][data-wcpt-price-type=" + c + "]").html()),
                            r = ["highest-price", "lowest-price", "sale-price", "regular-price"];
                        t.each(r, function(e, c) {
                        ...
                        var a = t(this),
                            e = a.attr("data-wcpt-element-id"),
                            c = a.attr("data-wcpt-stock"),
                            i = a.attr("data-wcpt-message_tpl"),
                            r = a.attr("data-wcpt-stock_class"),
                        ...
                        var a = t(this),
                            e = a.attr("data-wcpt-stock"),
                            c = a.attr("data-wcpt-stock-range-labels"),
                            i = c && "{}" != c ? JSON.parse(c) : [],
                            r = e,
                            o = !1;
                        ...
                        var a = t(this),
                            e = a.attr("data-wcpt-element-id"),
                            c = a.closest(".wcpt-row").attr("data-wcpt-product-id"),
                ...
                if (!t.isEmptyObject(e.variation)) {
                    r = c.find('[data-wcpt-link-code^="cart"]');
                    b(r, "wcpt-no-variation-selected"), e.variation.is_in_stock ? b(r, "wcpt-variation-out-of-stock") : m(r, "wcpt-variation-out-of-stock");
                    o = c.find(".wcpt-quantity input[type=number].qty");
                    o.length && o.each(function() {
                        var a = t(this),
                            c = a.closest(".wcpt-quantity"),
                            i = a.attr("data-wcpt-initial-value"),
                            r = e.variation.min_qty ? parseFloat(e.variation.min_qty) : 1,
                            o = e.variation.max_qty ? parseFloat(e.variation.max_qty) : "",
                            n = e.variation.step ? parseFloat(e.variation.step) : "",
                            s = "",
                            p = parseFloat(a.val());
                    ...
                    var l = c.find(".wcpt-quantity > select.wcpt-qty-select");
                    if (l.length) {
                        var d = l.attr("data-wcpt-qty-label"),
                            _ = parseInt(l.attr("data-wcpt-max-qty")),
                            u = e.variation.min_qty,
                            v = '<option value="' + e.variation.min_qty + '" selected="selected">' + d + e.variation.min_qty + "</option>";
                        for (e.variation.max_qty && (_ = e.variation.max_qty); u < _;) u += e.variation.step || 1, v += "<option>" + u + "</option>";
                        l.html(v), l.attr("min", e.variation.min_qty)
                    }
                    n = t(".wcpt-product-image-wrapper", c), s = t(".wcpt-product-image-wrapper > img:not(.wcpt-product-image-on-hover)", c), p = U(c);
                    s[0] ? (p.data("wcpt_default_image") || p.data("wcpt_default_image", s[0].outerHTML), s.length && e.variation.image && e.variation.image.src && (s.attr({
                        src: e.variation.image.src,
                        srcset: e.variation.image.srcset ? e.variation.image.srcset : ""
                    }), n.hasClass("wcpt-lightbox-enabled") && (n.attr("data-wcpt-lightbox--original") || n.attr("data-wcpt-lightbox--original", n.attr("data-wcpt-lightbox")), n.attr("data-wcpt-lightbox", e.variation.image.full_src)), n.hasClass("wcpt-product-image-wrapper--offset-zoom-enabled") && (n.attr("data-wcpt-offset-zoom-image-src--original") || n.attr("data-wcpt-offset-zoom-image-src--original", n.attr("data-wcpt-offset-zoom-image-src")), n.attr("data-wcpt-offset-zoom-image-src", e.variation.image.full_src)))) : D(n), e.variation.sku && c.find(".wcpt-sku").each(function() {
                        var a = t(this);
                        ...
                        var a = t(this),
                            c = a.attr("data-wcpt-precision"),
                            i = parseFloat(e.variation.display_price) < parseFloat(e.variation.display_regular_price),
                            r = a.find(".wcpt-on-sale__price-diff"),
                            o = a.find(".wcpt-on-sale__percent-diff");
                        i ? (a.removeClass("wcpt-hide"), price_diff = e.variation.display_regular_price - e.variation.display_price, percent_diff = parseFloat((price_diff / e.variation.display_regular_price * 100).toFixed(c)), r.html(V(price_diff)), o.text(percent_diff)) : a.addClass("wcpt-hide")
                    }), c.filter(".wcpt-product-type-variable").find(".wcpt-availability.wcpt-variable-switch").each(function() {
                        var a = t(this),
                            c = a.attr("data-wcpt-element-id"),
                            i = "",
                        ...
                        var a = t(this),
                            c = e.variation.stock,
                            i = a.attr("data-wcpt-stock-range-labels"),
                            r = i && "{}" != i ? JSON.parse(i) : [],
                            o = c;
                        if (null != o && NaN != o) {
                            a.show();
                        ...
                        var a = t(this);
                        a.html(e.variation.dimensions_html)
                    }), c.filter(".wcpt-product-type-variable").find(".wcpt-custom-field.wcpt-variable-switch").each(function() {
                        var a = t(this),
                            c = a.attr("data-wcpt-element-id"),
                            i = a.closest(".wcpt").attr("data-wcpt-table-id");
                ...
                var e = t(this),
                    c = e.find("option:selected"),
                    i = e.closest(".wcpt-row");
                i.trigger("select_variation", {
                    variation_id: e.val(),
            ...
            }), t(".wcpt").length && t(document).off("change", ".qty"), "ontouchstart" in document.documentElement) var bt = "touchstart",
            yt = "touchend";
        else bt = "mousedown", yt = "mouseup";
        if (t("body").on(bt + ("touchstart" == bt ? " dblclick" : ""), ".wcpt-qty-controller:not(.wcpt-disabled)", function(a) {
                if (t("body").addClass("wcpt-noselect--qty-increment"), "dblclick" !== a.type) {
                    var e = t(this),
                        c = e.parent(),
                        i = c.find(".qty"),
                        r = i.attr("min") ? i.attr("min") : 0,
                        o = !!i.attr("max") && i.attr("max"),
                        n = i.attr("step") ? i.attr("step") : 1,
                        s = i.val() > -1 ? i.val() : r;
                    if (!n % 1 ? (r = parseInt(r), o = parseInt(o), n = parseInt(n), s = parseInt(s)) : (r = parseFloat(r), o = parseFloat(o), n = parseFloat(n), s = parseFloat(s)), isNaN(s) && (s = 0), e.hasClass("wcpt-plus")) i.val((1e12 * s + 1e12 * n) / 1e12).change();
                    else {
                    ...
                    var l = 0,
                        d = setInterval(function() {
                            if (l++, !(l % 5 || l < 50 || e.hasClass("wcpt-disabled"))) {
                                var t = i.val() ? i.val() : r;
                                if (t = !n % 1 ? parseInt(t) : parseFloat(t), e.hasClass("wcpt-plus")) i.val((1e12 * t + 1e12 * n) / 1e12).change();
                                else {
                    ...
                    e.data("wcpt_clear", d), e.one(yt + " mouseout", function() {
                        var a = t(this),
                            e = a.data("wcpt_clear");
                ...
                var c = t(this),
                    i = c.attr("min") ? parseFloat(c.attr("min")) : 0,
                    r = c.attr("max") ? parseFloat(c.attr("max")) : 1e12,
                    o = c.attr("data-wcpt-initial-value"),
                    n = c.attr("step") ? parseFloat(c.attr("step")) : 1,
                    s = parseFloat(c.val());
                ...
                e || c.trigger("change", !0), R(t(this).parent())
            }), t("body").on("keypress", ".wcpt-quantity .qty", function(a) {
                if (13 == a.keyCode) {
                    var e = w(t(this));
                    e.find('.wcpt-button[data-wcpt-link-code^="cart"]').eq(0).click()
                }
            }), t("body").on("wcpt_after_every_load.wcpt_initial_qty_update", ".wcpt", function() {
                var a = t(this),
                    e = t('.wcpt-quantity input[type="number"].qty', wcpt_util.get_uninit_rows(a));
                e.each(function() {
                    var a = t(this),
                        e = a.attr("data-wcpt-initial-value");
                    if ("0" === e) a.val(0);
                    else if ("empty" === e) a.val("");
                    else if ("min" === e) {
                ...
                var e = t(this),
                    c = e.attr("max") ? parseFloat(e.attr("max")) : 1e9,
                    i = e.attr("min") ? parseFloat(e.attr("min")) : 1,
                    r = e.attr("step") ? parseFloat(e.attr("step")) : 1,
                    o = e.val() ? parseFloat(e.val()) : 0,
                    n = e.closest(".wcpt-quantity");
                if (n.removeClass("wcpt-quantity-error wcpt-quantity-error--min wcpt-quantity-error--max wcpt-quantity-error--step"), o) {
                    ...
                    var s = wcpt_get_sibling_rows(e.closest(".wcpt-row")),
                        p = s.find('.wcpt-button[data-wcpt-link-code^="cart_"]');
                    n.hasClass("wcpt-quantity-error") ? m(p, "wcpt-quantity-input-error") : b(p, "wcpt-quantity-input-error"), R(n)
                }
            }), t("body").on("change", ".wcpt-quantity input.qty, select.wcpt-qty-select", function(a, e) {
                var c = t(this),
                    i = w(c),
                    r = i.find("input.qty, select.wcpt-qty-select").not(this),
                    o = c.val();
                ...
                M(t(this).closest(".wcpt-row"))
            }), t("body").on("keyup change", ".wcpt .wcpt-name-your-price--input", function(a) {
                var e = t(this),
                    c = e.val(),
                    i = wcpt_get_sibling_rows(e.closest(".wcpt-row")),
                    r = t(".wcpt-quantity input.qty", i),
                    o = r.val(),
                    n = t(".wcpt-cart-checkbox ", i);
                if (rt(e), c && !o) r.val(r.attr("min"));
                else if (!c && o) {
                    var s = r.attr("data-wcpt-nyp-initial-value"),
                        p = r.attr("min");
                    "empty" === s ? p = "" : "0" === s && (p = "0"), r.val(p)
                }
                M(t(this).closest(".wcpt-row")), r.length ? r.change() : n.length && i.trigger("wcpt_checkbox_change", !!e.val())
            }), t("body").on("click", ".wcpt-player__button", function() {
                var a = t(this),
                    e = a.closest(".wcpt-player"),
                    c = e.attr("data-wcpt-src"),
                    i = e.attr("data-wcpt-loop"),
                    r = e.data("wcpt-media-el");
                if (r || (r = t('<audio class="wcpt-audio-elm" src="' + c + '"></audio>'), e.append(r), e.data("wcpt-media-el", r), i ? r.prop("loop", !0) : r.on("ended", function() {
                        e.toggleClass("wcpt-player--playing")
                    })), a.hasClass("wcpt-player__play-button")) {
                    r[0].play(), e.hasClass("wcpt-media-loaded") || r.on("canplay", function() {
                        e.addClass("wcpt-media-loaded")
                    }), t("audio.wcpt-audio-elm").not(r).each(function() {
                        this.currentTime = 0, this.pause()
                    });
                    var o = t(".wcpt-player.wcpt-player--playing").not(e);
                    o.find(".wcpt-player__pause-button").click()
                } else r[0].pause();
                e.toggleClass("wcpt-player--playing")
            }), t("body").on("click", ".wcpt-trigger_filter > [data-wcpt-slug]", function() {
                var a = t(this),
                    e = a.attr("data-wcpt-slug"),
                    c = a.parent().attr("data-wcpt-taxonomy"),
                    i = a.closest(".wcpt"),
                    r = i.find(".wcpt-navigation"),
                    o = r.find('[data-wcpt-taxonomy="' + c + '"] [data-wcpt-slug="' + e + '"]'),
                    n = t("input", o);
                o.length && (r.addClass("wcpt-force-hide-dropdown-menus"), n.prop("checked", !n.prop("checked")), r.trigger("change"))
            }), t("body").on("click", ".wcpt-archive_redirect > [data-wcpt-slug]", function() {
                var a = t(this),
                    e = a.attr("data-wcpt-archive-url");
                a.is("a") || (window.location = e)
            }), t("body").on("click", ".wcpt-row:not(.wcpt-removing-product) .wcpt-remove:not(.wcpt-disabled)", function() {
                var a = t(this),
                    e = $product_row = w(a),
                    c = e.attr("data-wcpt-product-id"),
                    i = e.attr("data-wcpt-variation-id"),
                    r = {
                        payload: {
                            products: {},
                            variations: {},
                            overwrite_cart_qty: !0
                        }
                    };
                ...
                a.preventDefault();
                var e = t(this);
                e.closest(".wcpt-toggle-enabled").toggleClass("wcpt-toggle")
            }), window.wcpt_get_sibling_rows = function(a) {
                var e = a.closest(".frzTbl");
                if (!e.length) return a;
                var c, i = a.attr("data-wcpt-product-id"),
                    r = a.attr("data-wcpt-variation-id");
                return c = r ? '[data-wcpt-variation-id="' + r + '"].wcpt-row.wcpt-product-type-variation' : '[data-wcpt-product-id="' + i + '"].wcpt-row:not(.wcpt-product-type-variation)', t(c, e)
            }, t("body").on("change", ".wcpt-cart-checkbox", function(a) {
                var e = t(this),
                    c = e.closest(".wcpt-row");
                c.trigger("_wcpt_checkbox_change", e.prop("checked"))
            }), t("body").on("_wcpt_checkbox_change", ".wcpt-row", function(a, e) {
                var c = t(this),
                    i = U(c),
                    r = i.closest("table"),
                    o = wcpt_get_sibling_rows(c),
                    n = t(".wcpt-cart-checkbox", o);
                ...
                t("body").on("change", ".wcpt input.qty, .wcpt select.wcpt-qty-select", function(a) {
                    var e = t(this),
                        c = e.closest(".wcpt-row"),
                        i = U(c);
                    e.closest("form.cart").length || "min" === e.attr("data-wcpt-initial-value") && !i.data("wcpt_checked") || i.trigger("_wcpt_checkbox_change", !!parseFloat(e.val()))
                })
            }, 1), t("body").on("wcpt_checkbox_change", ".wcpt-row", function(a, e) {
                var c = t(this),
                    i = wcpt_get_sibling_rows(c),
                    r = t("input.qty, select.wcpt-qty-select", i),
                    o = t(".wcpt-quantity", i);
                r.each(function() {
                    var a = t(this),
                        c = a.val(),
                        i = a.attr("data-wcpt-min") ? parseFloat(a.attr("data-wcpt-min")) : a.attr("min"),
                        n = a.attr("data-wcpt-initial-value");
                    e ? c && "0" !== c && !isNaN(c) || (c = i) : c = "empty" == n ? "" : "0" == n ? 0 : i, r.val(c), R(o)
                })
            }), t("body").on("wcpt_checkbox_change", ".wcpt-row", function(a, e) {
                var c = t(this),
                    i = wcpt_get_sibling_rows(c);
                M(i)
            }), t("body").on("wcpt_checkbox_change", ".wcpt-row", Q), t("body").on("click", ".wcpt-cart-checkbox-heading", function() {
                var a = t(this),
                    e = a.prop("checked"),
                    c = a.closest(".wcpt"),
                    i = H(c),
                    r = t(".wcpt-row", i);
                r.trigger("_wcpt_checkbox_change", e), t("wcpt-cart-checkbox--last-clicked", i).removeClass("wcpt-cart-checkbox--last-clicked")
            }), t("body").on("wcpt_checkbox_change", ".wcpt-row", function(a, e) {
                clearTimeout(window.wcpt_cb_heading), window.wcpt_cb_heading = setTimeout(function() {
                    t(".wcpt").each(function() {
                        var a = t(this),
                            e = a.find(".wcpt-cart-checkbox-heading").filter(":visible"),
                            c = a.find(".wcpt-cart-checkbox"),
                            i = !c.filter(":visible").not(":disabled").not(":checked").length;
                        e.prop("checked", i)
                    })
                }, 100)
                ...
                if ($last_clicked = r.filter(".wcpt-cart-checkbox--last-clicked"), checked = c.prop("checked"), $last_clicked.removeClass("wcpt-cart-checkbox--last-clicked"), c.addClass("wcpt-cart-checkbox--last-clicked"), $last_clicked.length && "undefined" != typeof wcpt_shiftKey && wcpt_shiftKey) {
                    var o = Math.min(r.index(c), r.index($last_clicked)),
                        n = Math.max(r.index(c), r.index($last_clicked));
                    r.filter(function() {
                        var a = t(this),
                            e = r.index(a);
                ...
                var e = t(this),
                    c = !!e.hasClass("wcpt-add-selected__select-all");
                $container = e.closest(".wcpt"), $table = H($container), $rows = t(".wcpt-row", $table), $rows.trigger("_wcpt_checkbox_change", c), t("wcpt-cart-checkbox--last-clicked", $table).removeClass("wcpt-cart-checkbox--last-clicked")
            }), t("body").on("wcpt_checkbox_change", ".wcpt-row", B), t("body").on("click", ".wcpt-cart-checkbox-trigger, .wcpt-cart-checkbox-trigger--local", X), window.wcpt_get_addons = function(a) {
                var e = t(".wcpt-add-to-cart-wrapper form", wcpt_get_sibling_rows(a)),
                    c = {},
                    i = e.find(".wcpa_form_outer");
                if (i.length) {
                    var r = i,
                        o = t("<form>");
                ...
                var a = t(this),
                    e = t(".wcpt-dropdown.wcpt-filter", a);
                e.each(function() {
                    var a = t(this);
                    if (a.hasClass("wcpt-filter--search-filter-options-enabled") && !t(".wcpt-search-filter-options", a).length) {
                        var e = t(".wcpt-dropdown-menu", a),
                            c = a.attr("data-wcpt-search-filter-options-placeholder");
                ...
                var e = t(this),
                    c = e.val().toLowerCase().trim(),
                    i = e.closest(".wcpt-filter"),
                    r = t(".wcpt-dropdown-option", i);
                ...
                r.each(function() {
                    var a = t(this),
                        e = a.text().toLowerCase().trim(); - 1 == e.indexOf(c) ? a.hide() : (a.show(), a.closest(".wcpt-dropdown-option.wcpt-accordion").addClass("wcpt-ac-open"))
                })
            }), t("body").on("change keydown keyup", ".wcpt-global-search__keyword-input", function() {
                var a = t(this),
                    e = a.closest(".wcpt-global-search");
                ...
                var a = t(this),
                    e = a.val(),
                    c = t('option[value="' + e + '"]', a),
                    i = c.text().trim(),
                    r = a.siblings(".wcpt-global-search__category-selector-facade");
                t(".wcpt-global-search__category-selector-facade__text", r).text(i)
            }), t("body").on("submit", ".wcpt-global-search__form", function(a) {
                var e = t(this),
                    c = e.find(".wcpt-global-search__keyword-input").val(),
                    i = e.find(".wcpt-global-search__category-selector"),
                    r = e.attr("data-wcpt-clear-redirect-url"),
                    o = e.attr("data-wcpt-clear-redirect"),
                    n = e.attr("data-wcpt-redirect"),
                    s = t(".wcpt-global-search__category-selector", e).val(),
                    p = e.attr("action");
                if (c) {
                    if ("category" == n && s) a.preventDefault(), window.location = wcpt_product_category_links[s] + "?s=" + c;
                    else if ("shop" == n) {
                        a.preventDefault();
                        var l = p + "?s=" + c;
                ...
                var a = t(this),
                    e = a.siblings(".wcpt-global-search__keyword-input"),
                    c = a.closest(".wcpt-global-search__form");
                e.val(""), c.submit()
            }), t("body").on("focus", ".wcpt-global-search__keyword-input", function() {
                var a = t(this),
                    e = a.parent();
                e.addClass("wcpt-global-search__keyword-input-wrapper--focus")
            }).on("blur", ".wcpt-global-search__keyword-input", function() {
                var a = t(this),
                    e = a.parent();
                e.removeClass("wcpt-global-search__keyword-input-wrapper--focus")
            }), window.wcpt_cart = function(a) {
                if (window.wcpt_cart_call_id && (!window.wcpt_cart_result_cache || window.wcpt_cart_call_id != window.wcpt_cart_result_cache.payload.wcpt_cart_call_id)) return !window.wcpt_cart_pending_req_params && (window.wcpt_cart_pending_req_params = {}), void t.extend(!0, window.wcpt_cart_pending_req_params, a);
                ...
                a = t.extend({}, e, a || {}), a.payload.wcpt_cart_call_id = window.wcpt_cart_call_id, a.payload.cart_widget_permitted = it(), t(".wcpt-cart-widget").addClass("wcpt-cart-widget--loading");
                var c = {
                    products: a.payload.products ? t.extend({}, a.payload.products) : {},
                    variations: a.payload.variations ? t.extend({}, a.payload.variations) : {}
                };
                if (void 0 !== a.payload && a.payload.variation_form && void 0 !== a.external_payload && a.external_payload["add-to-cart"]) {
                    var i = a.external_payload["add-to-cart"],
                        r = a.external_payload.variation_id ? a.external_payload.variation_id : "",
                        o = parseFloat(a.external_payload.quantity);
                    c.products[i] = o, r && (c.variations[i] = {}, c.variations[i][r] = o)
                }
                t(".wcpt-row:visible").each(function() {
                    var a = t(this),
                        e = wcpt_get_sibling_rows(a),
                        i = a.attr("data-wcpt-product-id"),
                        r = a.attr("data-wcpt-variation-id"),
                        o = t(dt, a),
                        n = parseFloat(a.attr("data-wcpt-in-cart"));
                    c.products && t.each(c.products, function(s, p) {
                        if (s == i) {
                            if (r && c.variations && c.variations[i] && void 0 === c.variations[i][r]) return;
                            if (y(o), 0 === p && n) a.addClass("wcpt-removing-product");
                            else {
                                a.addClass("wcpt-adding-product");
                                var l = t("input.qty", a),
                                    d = l.not(".cart .qty"),
                                    w = d.attr("data-wcpt-initial-value"),
                                    _ = parseFloat(d.attr("data-wcpt-min")),
                                    u = d.attr("data-wcpt-return-to-initial");
                                u && (e.trigger("_wcpt_checkbox_change", !1), "min" == w ? l.val(_) : "0" === w ? l.val(0) : "empty" === w && l.val(""));
                                var v = l.closest(".wcpt-quantity");
                                v.length && R(v);
                                l = t("select.wcpt-qty-select", a);
                                var h = l.children("option:first-child");
                                l.val(h.attr("value"))
                            }
                            var f = t(".wcpt-total", e),
                                g = p;
                            r && c.variations && c.variations[i] && c.variations[i][r] && (g = c.variations[i][r]), f.length && M(e, g)
                        }
                    })
                });
                var n = t.extend({}, {
                    wcpt_payload: a.payload,
                    lang: wcpt_i18n.lang
                }, a.external_payload ? a.external_payload : {});
                t("body").trigger("wcpt_cart_request", n), a.payload.use_cache && window.wcpt_cart_result_cache ? (window.wcpt_cart_result_cache.payload.wcpt_cart_call_id = window.wcpt_cart_call_id, t("body").trigger("wcpt_cart", window.wcpt_cart_result_cache)) : t.post(wcpt_params.wc_ajax_url.replace("%%endpoint%%", "wcpt_cart"), n, function(a) {
                    ...
                    a.always && a.always(e), window.wcpt_cart_pending_req_params && (wcpt_cart(window.wcpt_cart_pending_req_params), window.wcpt_cart_pending_req_params = !1), a.redirect && (!e.success && e.notice ? t("body").on("click touchstart", ".wcpt-notice-wrapper", function() {
                        window.location = a.redirect
                    }) : window.location = a.redirect)
                })
            }, t("body").on("wcpt_cart", function(a, e) {
                if (!window.wcpt_cart_pending_req_params) {
                    if (e.payload.wcpt_cart_call_id === window.wcpt_cart_call_id && t(".wcpt-cart-widget ").removeClass("wcpt-cart-widget--loading"), !e.success && e.notice) {
                        var c = t("body"),
                            i = t('<div class="wcpt-notice-wrapper">' + e.notice + "</div>");
                        c.append(i), c.one("click", function() {
                            i.remove()
                        })
                    }
                    if (e.cart_widget && it()) {
                        c = t("body");
                        var r = t(".wcpt-cart-widget").not(".wcpt-cart-checkbox-trigger"),
                            o = t(e.cart_widget);
                        o.hasClass("wcpt-hide") ? c.removeClass("wcpt-cart-widget-visible") : c.addClass("wcpt-cart-widget-visible"), c.append(o), r.remove()
                    }
                    var n = removed = !1;
                    e.payload.products && e.in_cart && t.each(e.payload.products, function(a, c) {
                        var i = variation_qty = !1;
                        e.payload.variations && void 0 !== e.payload.variations[a] && (i = Object.keys(e.payload.variations[a])[0], variation_qty = Object.values(e.payload.variations[a])[0]), "0" === c ? (t.isEmptyObject(e.in_cart) || !e.in_cart.length || !e.in_cart[a] || i && !e.in_cart[a][i]) && (removed = !0) : t.isEmptyObject(e.in_cart) || !e.in_cart[a] || i && !e.in_cart[a][i] || (n = !0)
                    }), e.payload.variation_form && (n = !0);
                    var s = [];
                    e.in_cart && t.each(e.in_cart, function(a, c) {
                        if ("object" == typeof c) {
                            var i = 0,
                                r = 0;
                            t.each(c, function(t, c) {
                                var o = e.in_cart_total[a][t];
                                s.push({
                                    id: t,
                                    type: "variation",
                                    quantity: c,
                                    total: o
                                }), i += parseFloat(c), r += parseFloat(o)
                            }), s.push({
                                id: a,
                                type: "variable",
                                quantity: i,
                            ...
                            type: "simple",
                            quantity: c,
                            total: e.in_cart_total[a]
                        })
                    });
                    var p = t(".wcpt-row");
                    if (p.each(function() {
                            var a = t(this),
                                c = a.attr("data-wcpt-type");
                            if (product_id = a.attr("data-wcpt-product-id"), variation_id = a.attr("data-wcpt-variation-id"), id = "variation" == c ? a.attr("data-wcpt-variation-id") : a.attr("data-wcpt-product-id"), cart_item = !1, min_call_id = a.data("wcpt-min-cart-call-id"), !(min_call_id > e.payload.wcpt_cart_call_id)) {
                                t.each(s, function(t, a) {
                                    if (variation_id && variation_id == a.id || !variation_id && product_id == a.id) return cart_item = a, !1
                                }), a.removeClass("wcpt-adding-product wcpt-removing-product");
                                var i = cart_item ? cart_item.quantity : 0;
                                a.attr("data-wcpt-in-cart", i), $in_cart = t(".wcpt-in-cart", a).text(i), $in_cart.each(function() {
                                    var a = t(this),
                                        e = a.attr("data-wcpt-template");
                                    a.text(e.replace("{n}", i))
                                });
                                var r = cart_item ? cart_item.total : 0;
                                if (t(".wcpt-total", a).attr("data-wcpt-in-cart-total", r), M(a), i ? $in_cart.removeClass("wcpt-disabled") : $in_cart.addClass("wcpt-disabled"), a.hasClass("wcpt-adding-product") || (d = t(dt, a), k(i, d), d.hasClass("wcpt-out-of-stock") || b(d)), !a.hasClass("wcpt-removing-product")) {
                                    var o = t(".wcpt-remove", a);
                                    cart_item ? o.removeClass("wcpt-disabled") : (o.addClass("wcpt-disabled"), t(".add_to_cart_button", a).removeClass("added").next(".added_to_cart").remove())
                                }
                            }
                        }), e.fragments && !e.payload.skip_cart_triggers && !e.is_cache) {
                        var l = !0,
                            d = (c = t("body"), !1);
                        e.payload && e.payload.products && 1 === Object.keys(e.payload.products).length && t.each(e.payload.products, function(a, e) {
                            d = t(e ? '<button data-product_id="' + a + '">' : '<a href="" data-product_id="' + a + '">')
                        }), (n || e.payload.force_refresh_cart) && c.trigger("added_to_cart", [e.fragments, e.cart_hash, d, l]), removed && c.trigger("removed_from_cart", [e.fragments, e.cart_hash, d, l])
                    }
                }
            }), t("body").on("added_to_cart removed_from_cart", function(t, a, e, c, i) {
                i || wcpt_cart({
                    payload: {
                        skip_cart_triggers: !0
                    }
                })
            }), t("body").on("wcpt_layout", ".wcpt", function(e, c) {
                var i = t(this),
                    r = t(".wcpt-navigation.wcpt-left-sidebar.wcpt-sticky:visible", i),
                    o = t(".wcpt-navigation.wcpt-header.wcpt-sticky:visible", i),
                    n = t(".frzTbl-fixed-heading-wrapper-outer:visible", i),
                    s = i.data("wcpt-sc-attrs"),
                    p = a(),
                    l = parseInt(s[p + "_scroll_offset"] ? s[p + "_scroll_offset"] : 0);
                r.css("top", l), "laptop" == p ? (o.css("top", l), l += parseInt(o.outerHeight()), n.css({
                    top: l
                })) : (l += parseInt(r.outerHeight()), o.css({
                    top: l
                }), l += o.outerHeight(), n.css({
                    top: l
                }))
            }), t("body").on("click", ".wcpt-cart-checkbox-trigger__close", function(a) {
                a.stopPropagation();
                var e = t(this),
                    c = e.closest(".wcpt-cart-checkbox-trigger");
                t(".wcpt-cart-checkbox:checked").click(), c.remove()
            }), t("body").on("input change", ".wcpt-range-input-min, .wcpt-range-input-max", function() {
                var a = t(this),
                    e = a.closest(".wcpt-range-options-main"),
                    c = e.find(".wcpt-range-input-min"),
                    i = (parseFloat(c.val()), e.find(".wcpt-range-input-max"));
                parseFloat(i.val());
                if ($range = e.find(".wcpt-range-slider.original"), $range.length) {
                    var r = parseFloat(a.attr("data-wcpt-actual-max")),
                        o = parseFloat(a.val());
                ...
                var a = t(this),
                    e = a.closest(".wcpt-range-options-main"),
                    c = t(".wcpt-range-input-min", e),
                    i = t(".wcpt-range-input-max", e),
                    r = e.find(".wcpt-range-slider.original"),
                    o = (e.find(".wcpt-range-slider.ghost"), parseFloat(r.prop("valueLow"))),
                    n = parseFloat(r.prop("valueHigh"));
                parseFloat(a.attr("max")), parseFloat(a.attr("step"));
                c.val(o), i.val(n)
            }), t("body").on("select_variation", ".wcpt-product-type-variable", function(a, e) {
                var c = w(t(this)),
                    i = t(".wcpt-variation-description__item", c);
                ...
                var c = w(t(this)),
                    i = t(".wcpt-name-your-price--input", c),
                    r = i.attr("data-wcpt-nyp-initial-value-field"),
                    o = !1,
                    n = !1,
                    s = !1,
                    p = !1;
                if (c.removeClass("wcpt-product-has-name-your-price"), c.data("wcpt_variation_selected")) {
                    var l = c.data("wcpt_variation");
                    l.is_nyp && (o = !0, n = l.minimum_price, s = l.maximum_price, p = l.suggested_price, c.addClass("wcpt-product-has-name-your-price"))
                } else o = !1;
                if (o) {
                ...
                var c = t(this),
                    i = wcpt_get_sibling_rows(c.closest(".wcpt-row")),
                    r = at(i);
                e ? rt(r) : r.val() || ot(r)
            }), t("body").on("change", ".wcpt-range-options-main input", function() {
                var a = t(this),
                    e = a.closest(".wcpt-filter");
                e.find("input[type=radio]").prop("checked", !1), j(a.closest(".wcpt-navigation"))
                ...
                e.wcpt_payload.skip_cart_triggers || e.wcpt_payload.use_cache || e.is_cache || t(".wcpt").each(function() {
                    var a = t(this),
                        e = JSON.parse(a.attr("data-wcpt-sc-attrs"));
                ...
                e.payload.skip_cart_triggers || e.payload.use_cache || e.is_cache || t(".wcpt").each(function() {
                    ...
                    }), ft(a, "", !0, "refresh_table")) : e.block_table && a.removeClass("wcpt-loading")
                })
                ...
                if ("undefined" != typeof WavePlayer) {
                    ...
                    var e = nt(a);
                    e.length && (e.replaceWith($wcpt_waveplayer_preserve), $wcpt_waveplayer_preserve.find(".wvpl-waveform canvas").each(function() {
                        var a = t(this);
                        a.width(a.attr("data-wcpt-last-width")), a.height(a.attr("data-wcpt-last-height"))
                    }), st.call($wcpt_waveplayer_preserve.get(0)), $wcpt_waveplayer_preserve = t(), WavePlayer.redrawAllInstances())
                }
            ...
            }), t("body").on("click", ".wcpt-row .wcpt-waveplayer-container", st), t("body").on("click", ".elementor-tab-title", function() {
                var a = t(this),
                    e = a.closest(".elementor-widget-container"),
                    c = e.find(".wcpt");
                c.trigger("wcpt_layout", {
                    source: "elementor__tab"
                })
            }), t("ul.et_pb_tabs_controls > li").on("click", function() {
                var a = t(this),
                    e = a.index(),
                    c = a.closest(".et_pb_tabs_controls"),
                    i = c.siblings(".et_pb_all_tabs"),
                    r = i.children().eq(e),
                    o = r.find(".wcpt");
                setTimeout(function() {
                    o.trigger("wcpt_layout", {
                        source: "divi__tab"
                    })
                }, 700)
            }), t(".et_pb_toggle_title").on("click", function() {
                var a = t(this),
                    e = a.next(".et_pb_toggle_content"),
                    c = e.find(".wcpt");
                setTimeout(function() {
                    c.trigger("wcpt_layout", {
                        source: "divi__tab"
                ...
                var a = t(this),
                    e = a.closest(".fl-accordion-item, .fl-tabs-panel"),
                    c = e.find(".wcpt");
                c.trigger("wcpt_layout", {
                    source: "beaver_builder__tab"
                })
            }), t("body").on("click", ".su-tabs-nav span", function() {
                var a = t(this),
                    e = a.index(),
                    c = a.closest(".su-tabs-nav"),
                    i = c.siblings(".su-tabs-panes"),
                    r = i.children().eq(e),
                    o = r.find(".wcpt");
                o.trigger("wcpt_layout", {
                    source: "shortcode_ultimate__tab"
                })
            }), t("body").on("click", ".su-spoiler-title", function() {
                var a = t(this),
                    e = a.closest(".su-spoiler"),
                    c = e.find(".wcpt");
                c.trigger("wcpt_layout", {
                ...
                var a = t(this),
                    e = a.index(),
                    c = a.closest(".vce-classic-tabs-container"),
                    i = c.siblings(".vce-classic-tabs-panels-container"),
                    r = i.children(".vce-classic-tabs-panels").children().eq(e),
                    o = r.find(".wcpt");
                setTimeout(function() {
                    o.trigger("wcpt_layout", {
                        source: "visual_composer__tab"
                    })
                }, 1)
            }), t("body").on("click", ".vce-classic-accordion-panel-heading", function() {
                var a = t(this),
                    e = a.closest(".vce-classic-accordion-panel"),
                    c = e.find(".wcpt");
                setTimeout(function() {
                    c.trigger("wcpt_layout", {
                ...
                var a = t(this),
                    e = a.index(),
                    c = a.closest(".wpsm_nav"),
                    i = c.siblings(".tab-content"),
                    r = i.children().eq(e),
                    o = r.find(".wcpt");
                o.trigger("wcpt_layout", {
                    source: "tabs_wpshopmart__tab"
                })
            }), t("body").on("click", ".tabtitle", function() {
                var a = t(this),
                    e = a.siblings(".tabcontent");
                t(".wcpt", e).trigger("wcpt_layout", {
                    source: "tabby_tab"
                })
            }), t("body").on("click", ".responsive-tabs__list__item", function() {
                var a = t(this),
                    e = a.index(),
                    c = a.closest(".responsive-tabs"),
                    i = t(".tabcontent", c).eq(e);
                t(".wcpt", i).trigger("wcpt_layout", {
                    source: "tabby_tab"
                })
            }), t("body").on("click", ".kt-title-item", function() {
                var a = t(this),
                    e = a.closest(".kt-tabs-wrap");
                setTimeout(function() {
                    e.find(".wcpt:visible").trigger("wcpt_layout")
                }, 100)
            }), t("body").on("click", ".wcpt-player--sonaar", function() {
                var a = t(this),
                    e = a.attr("data-wcpt-sonaar-playlist-id");
            ...
            function kt(a) {
                var e = t("#wcpt-ti-wishlist-growler-template").html(),
                    c = t(e.replace("{n}", '"' + a.name + '"')),
                    i = "wcpt-ti-wishlist-growler--revealed",
                    r = 1e3 * a.duration_seconds;
                c.attr("data-wcpt-icon", a.icon), t(".wcpt-ti-wishlist-growler").remove(), a.item_added_label && t(".wcpt-ti-wishlist-growler__label--item-added", c).text(a.item_added_label.replace("{n}", '"' + a.name + '"')), a.view_wishlist_label && t(".wcpt-ti-wishlist-growler__label--view-wishlist", c).text(a.view_wishlist_label.replace("{n}", '"' + a.name + '"')), a.url ? c.attr("href", a.url) : wcpt_ti_wishlist_url && c.attr("href", wcpt_ti_wishlist_url), t("body").append(c), setTimeout(function() {
                    c.addClass(i)
            ...
            function Ct(a) {
                var e = a.attr("data-wcpt-type"),
                    c = a.attr("data-wcpt-product-id"),
                    i = a.data("wcpt_variation_id") ? a.data("wcpt_variation_id") : !!a.attr("data-wcpt-variation-id") && a.attr("data-wcpt-variation-id"),
                    r = t(".wcpt-wishlist", wcpt_get_sibling_rows(a)),
                    o = r.attr("data-wcpt-variable-permitted");
                if ("variable" !== e || o || i) {
                    r.removeClass("wcpt-disabled wcpt-loading");
                    var n = i || c; - 1 === wcpt_ti_wishlist_ids.indexOf(n + "") ? r.removeClass("wcpt-active") : r.addClass("wcpt-active")
            ...
            setTimeout(function() {
                ...
                if ("variable" != r || s || n) {
                    ...
                    if (-1 === wcpt_ti_wishlist_ids.indexOf(p)) t.ajax({
                        ...
                        "variable" === r && i.data("wcpt_sc_attrs").ti_wishlist && window.location.reload(), Ct(c), kt({
                    ...
                    }), wcpt_ti_wishlist_ids.push(p), e.addClass("wcpt-active");
                    else {
                        t.ajax({
                            url: wcpt_params.ajax_url,
                            method: "POST",
                        ...
                        if (w > -1 && wcpt_ti_wishlist_ids.splice(w, 1), Ct(c), i.data("wcpt_sc_attrs").ti_wishlist) {
                            var _ = c;
                ...
                var a = t(this),
                    e = wcpt_util.get_uninit_rows(a).filter(":visible");
        ...
        t("body").on("select_variation", ".wcpt-row", function() {
            var a = t(this),
                e = a.data("wcpt_variation"),
                c = t(".wcpt-wholesale", a);
            c.each(function() {
                var a = t(this);
                ...
                if (a.hasClass("wcpt-wholesale--wholesale-price")) {
                    ...
                    if (e) {
                        var o = "";
                        e.wholesale_price && (o = e.wholesale_price), r = V(o)
                    }
                ...
                if (a.hasClass("wcpt-wholesale--original-price")) {
                    ...
                    if (e) {
                        var n = "";
                        n = e.wholesale_price ? e.original_display_price : e.display_price, r = V(n)
                    }
                    t(".wcpt-wholesale__variation-view", a).text(r)
                }
            ...
            var a = t(this),
                e = a.closest(".variations_form");
            e.hasClass("wvs-loaded") && E(e)
            ...
            var a = t(this);
            t(".afrfqbt, .afrfqbt_single_page", wcpt_util.get_uninit_rows(a)).removeClass("afrfqbt afrfqbt_single_page").addClass("wcpt-afrfqbt"), t(".added_quote_pro").remove(), lt(a)
        }), setTimeout(lt, 500), t("body").on("select_variation", ".wcpt-product-type-variable", function() {
            var a = t(this),
                e = a.data("wcpt_variation_id"),
                c = t(".wcpt-afrfqbt", a);
            lt(a), e ? c.removeClass("disabled") : c.addClass("disabled")
            ...
            var e = t(this),
                ...
                o = !1,
                n = 0;
            if (n = t(".cart .qty", c).length ? t(".cart .qty", c).val() : t(".qty", c).val(), n || (n = 1), c.hasClass("wcpt-product-type-variable") ? (r = c.data("wcpt_variation_id"), o = c.data("wcpt_attributes")) : c.hasClass("wcpt-product-type-variation") && (r = c.attr("data-wcpt-variation-id"), o = c.data("wcptVariationAttributes")), !c.hasClass("wcpt-product-type-variable") || r) {
                if (!e.hasClass("disabled")) {
                    if (e.removeClass("added"), r) {
                        var s = {
                        ...
                        s.form_data = t.param(s.form_data), t.extend(s.form_data, o)
                    } else s = {
                    ...
                    t.ajax({
                        ...
                        e.removeClass("loading"), r ? wcpt_afrfq_params.product_ids.push(parseInt(r)) : wcpt_afrfq_params.product_ids.push(parseInt(i)), lt(e), "success" !== a && t(".quote-li").replaceWith(a["mini-quote"])
                    })
                }
            } else alert(wcpt_i18n.i18n_make_a_selection_text)
        });
        var xt = t(".wcpt");
        xt.length && xt.each(function() {
            r(t(this))
        }), d();
        var qt = !1;
        (-1 !== document.cookie.indexOf("woocommerce_items_in_cart") || "undefined" != typeof wcpt_cart_result_cache && wcpt_cart_result_cache.cart_quantity) && (qt = !0), qt && wcpt_cart({
            payload: {
                skip_cart_triggers: !0
            }
        }), t(window).on("pageshow", function(t) {
            t.originalEvent.persisted && wcpt_cart({
                payload: {
                    skip_cart_triggers: !0
                }
            })
    ...
    function(t) {
        function a() {
            ...
            t(".wcpt-child-row:not(.wcpt-child-row--init)", a).each(function() {
                var a = t(this);
                a.trigger("wcpt_init_child_row").addClass("wcpt-child-row--init")
            })
        }
        ...
        function i() {
            var a = t(this),
                e = a.data("wcpt_parent_row"),
                c = e.css("background-color"),
                i = t("> td:first-child", e),
                r = i.css("background-color"),
                o = r && "rgba(0, 0, 0, 0)" !== r ? r : c;
            t(">td", a).css({
                "background-color": o
            })
        }
        ...
        function o() {
            var a = t(this),
                c = a.closest(".wcpt-row"),
                i = ".wcpt-child-row-toggle, a, .wcpt-tooltip, input, button, .wcpt-button, .wcpt-link, .wcpt-quantity";
            t(e.target).closest(i).length || t(".wcpt-child-row-toggle", c).click()
        }

        function n() {
            var a = t(this),
                e = a.data("wcpt_child_row") || t();
            e.addClass("wcpt-parent-row-hovered")
        }

        function s() {
            var a = t(this),
                e = a.data("wcpt_child_row") || t();
            e.removeClass("wcpt-parent-row-hovered")
        }

        function p() {
            var a = t(this),
                e = a.data("wcpt_parent_row") || t();
            e.addClass("wcpt-child-row-hovered")
        }

        function l() {
            var a = t(this),
                e = a.data("wcpt_parent_row") || t();
            e.removeClass("wcpt-child-row-hovered")
        }
        t("body").on("wcpt_after_every_load", ".wcpt", a), t("body").on("wcpt_init_child_row", ".wcpt-child-row", c), t("body").on("wcpt_init_child_row", ".wcpt-child-row", i), t("body").on("click", ".wcpt-child-row-toggle", r), t("body").on("click", ".wcpt-has-child-row--click-anywhere", o), t("body").on("mouseenter", ".wcpt-has-child-row", n), t("body").on("mouseleave", ".wcpt-has-child-row", s), t("body").on("mouseenter", ".wcpt-child-row", p), t("body").on("mouseleave", ".wcpt-child-row", l)
    }(jQuery),
    function(t) {
        function a() {
            var a = t(this),
                e = t(".wcpt-search-wrapper", a);
        ...
        t("body").on("wcpt_after_every_load", ".wcpt", a), t("body").on("keyup input", ".wcpt-instant-search .wcpt-search-input", function(a) {
            var e = t(this),
                c = e.val().toLowerCase().trim(),
                i = e.closest(".wcpt"),
                r = t(".wcpt-table:visible:not(.frzTbl-clone-table)", i),
                o = t(".wcpt-row", r);
            c ? (o.each(function() {
                var a = t(this),
                    e = !1,
                    i = a.data("wcpt_instant_search_text");
                ...
                var a = t(this),
                    e = a.attr("data-wcpt-group-by-category-slug");
    ...
    function(t) {
        function a() {
            var a = t(this),
                c = a.data("wcpt_sc_attrs");
            if (c.instant_sort) {
                var i = [];
                t(".wcpt-row:not(.wcpt-child-row):not(.wcpt-row--category-heading)", a).each(function() {
                    var a = t(this),
                        e = a.attr("data-wcpt-product-id"),
                        c = a.attr("data-wcpt-variation-id"),
                        r = t.extend({}, {
                            id: e,
                            variation_id: c
                        }, JSON.parse(a.attr("data-wcpt-instant-sort-props")));
                    i.push(r)
                }), a.data("wcpt_sort_data", i), wcpt_util.do_once_on_container(a, "wcpt-instant-sort-init", function(a) {
                    a.off("click.wcpt_sort_by_column_headings", ".wcpt-heading.wcpt-sortable").removeClass("wcpt-sortable-headings-init"), a.on("click.wcpt_instant_sort", ".wcpt-heading.wcpt-sortable", function() {
                        var a = t(this),
                            c = t(".wcpt-sorting-icons", a),
                            i = c.hasClass("wcpt-sorting-asc") ? "desc" : "asc",
                            r = a.closest(".wcpt"),
                            o = JSON.parse(r.attr("data-wcpt-instant-sort-params")),
                            n = {};
                        t.each(o.column_heading, function(t, a) {
                            if (c.hasClass("wcpt-" + t)) return n = a, !1
                        }), t.extend(n, {
                            order: i
                        }), wcpt_instant_sort(n, r), e(n, r)
                    }), a.on("change.wcpt_instant_sort", '[data-wcpt-filter="sort_by"] input[type="radio"]', function(a) {
                        a.stopPropagation();
                        var c = t(this),
                            i = c.closest(".wcpt-option, .wcpt-dropdown-option"),
                            r = c.closest(".wcpt"),
                            o = JSON.parse(r.attr("data-wcpt-instant-sort-params")),
                            n = i.index(),
                            s = o.dropdown[n];
                        wcpt_instant_sort(s, r), e(s, r)
                    })
                })
            } else a.removeClass("wcpt-instant-sort-init"), a.off("change.wcpt_instant_sort"), a.off("click.wcpt_instant_sort")
        }

        function e(a, e) {
            var c = JSON.parse(e.attr("data-wcpt-instant-sort-params")); - 1 !== t.inArray(a.orderby, ["rating", "price-desc"]) && (a.order = "desc"), "price-desc" == a.orderby && (a.orderby = "price"), t.each(c.dropdown, function(c, i) {
                if (-1 !== t.inArray(i.orderby, ["rating", "price-desc"]) && (i.order = "desc"), "price-desc" == i.orderby && (i.orderby = "price"), !(a.orderby !== i.orderby || a.order && a.order.toLowerCase() !== i.order.toLowerCase() || "meta_key" == a.orderby && a.meta_key && a.meta_key.toLowerCase() !== i.meta_key.toLowerCase() || -1 !== t.inArray(a.orderby, ["attribute", "attribute_num"]) && a.orderby_attribute && a.orderby_attribute.toLowerCase() !== i.orderby_attribute.toLowerCase() || "taxonomy" == a.orderby && a.orderby_taxonomy && a.orderby_taxonomy.toLowerCase() !== i.orderby_taxonomy.toLowerCase())) {
                    var r = t('[data-wcpt-filter="sort_by"]', e),
                        o = r.find("input").eq(c),
                        n = o.closest(".wcpt-dropdown-option, .wcpt-option"),
                        s = t(".wcpt-dropdown-label", r);
                    s.text(t("span", n).text()), o.prop("checked", !0), n.addClass("wcpt-active").siblings().removeClass("wcpt-active"), r.removeClass("wcpt-open")
                }
            }), t.each(c.column_heading, function(c, i) {
                if (!(a.orderby !== i.orderby || "meta_key" == a.orderby && a.meta_key && a.meta_key.toLowerCase() !== i.meta_key.toLowerCase() || -1 !== t.inArray(a.orderby, ["attribute", "attribute_num"]) && a.orderby_attribute && a.orderby_attribute.toLowerCase() !== i.orderby_attribute.toLowerCase() || "taxonomy" == a.orderby && a.orderby_taxonomy && a.orderby_taxonomy.toLowerCase() !== i.orderby_taxonomy.toLowerCase())) {
                    var r = t(".wcpt-" + c, e),
                        o = a.order.toLowerCase();
        ...
        t("body").on("wcpt_after_every_load", ".wcpt", a), window.wcpt_instant_sort = function(a, e) {
            ...
            switch (a.order || (a.order = "asc"), a.order = a.order.toLowerCase(), -1 !== t.inArray(a.orderby, ["price-desc", "rating"]) && (a.order = "desc"), a.orderby) {
                ...
                case "meta_value":
                    c.sort(function(t, e) {
                        var c = t["meta_value__" + a.meta_key],
                            i = e["meta_value__" + a.meta_key];
                ...
                case "meta_value_num":
                    c.sort(function(t, e) {
                        var c = t["meta_value__" + a.meta_key],
                            i = e["meta_value__" + a.meta_key],
                            r = isNaN(parseFloat(c)) ? 0 : parseFloat(c),
                            o = isNaN(parseFloat(i)) ? 0 : parseFloat(i);
                        return "asc" == a.order ? r - o : o - r
                    });
                    break;
                case "attribute":
                    c.sort(function(t, e) {
                        var c = t["attribute__" + a.orderby_attribute],
                            i = e["attribute__" + a.orderby_attribute];
                        return "asc" == a.order ? c.localeCompare(i) : i.localeCompare(c)
                    });
                    break;
                case "attribute_num":
                ...
                case "taxonomy":
                    c.sort(function(t, e) {
                        var c = t["taxonomy__" + a.orderby_taxonomy],
                            i = e["taxonomy__" + a.orderby_taxonomy];
                        return "asc" == a.order ? c.localeCompare(i) : i.localeCompare(c)
                    });
                    break;
                case "taxonomy_num":
            ...
            t.each(c, function(a, c) {
                var i = !1;
                i = c.variation_id ? e.find('.wcpt-row[data-wcpt-variation-id="' + c.variation_id + '"]') : e.find('.wcpt-row[data-wcpt-product-id="' + c.id + '"]'), i.each(function() {
                    var a = t(this),
                        e = a.closest("tbody");
                    a.detach().appendTo(e)
                })
    ...
    function(t) {
        function a(a, e, c) {
            ...
            var r = t("<a>", {
                href: "data:Application/octet-stream," + encodeURIComponent(i),
                download: c + ".csv"
            });
        ...
        t("body").on("click", ".wcpt-csv-download", function() {
            var e = t(this),
                c = e.attr("data-wcpt-csv-session-key"),
                i = e.attr("data-wcpt-csv-include-all-products"),
                r = window[e.attr("data-wcpt-headings-js-var-name")].join(","),
                o = e.attr("data-wcpt-file-name");
            e.hasClass("wcpt-disabled") || t.ajax({
                url: wcpt_params.wc_ajax_url.replace("%%endpoint%%", "wcpt_get_csv"),
                method: "POST",
                beforeSend: function() {
                    e.addClass("wcpt-disabled wcpt-loading")
                },
                data: {
                    wcpt_csv_session_key: c,
                    wcpt_csv_include_all_products: i
                }
            }).done(function(t) {
                e.removeClass("wcpt-disabled wcpt-loading"), a(t, r, o)
            })
        })
    }(jQuery),
    function(t) {
        ...
        t("body").on("wcpt_after_every_load", ".wcpt", function() {
            var a = t(this),
                e = wcpt_util.get_sc_attrs(a),
                c = t(".wcpt-infinite-scroll-dots", a);
            if (c.length) {
                wcpt_util.do_once_on_container(a, "wcpt-infinite-scroll-init", function(t) {
                ...
                var i = a.data("wcpt-infinite-scroll-intersection-observer");
                if (i.observe(c[0]), !e.disable_url_update) {
                    var r = a.attr("data-wcpt-query-string");
                    if (r) {
                        var o = wcpt_util.get_table_id(a);
                        wcpt_util.remove_param_from_url(`${o}_paged`)
                    }
                }
            }
            ...
            var e = wcpt_util.get_table_id(t),
                c = wcpt_util.get_current_page_number(t),
                i = `${e}_paged=${c+1}`,
                r = !0,
                o = "infinite_scroll",
                n = window.wcpt_build_ajax_query_string(t, i, r, o);
            window.wcpt_fetch_markup_and_apply_callback(t, n, o, a), t.removeClass("wcpt-loading"), t.addClass("wcpt-infinite-scroll-loading-results")
        })
    }(jQuery),
    function(t) {
        ...
        var c = a.data("wcpt-disabled-modules");
        c || (c = []);
        for (var i = c.length; i;) --i, c[i].module == t && c[i].source == e && c.splice(i, 1);
        a.data("wcpt-disabled-modules", c)
    },
    function(t) {
        window.wcpt_util = {
            get_table_id: t => t.attr("data-wcpt-table-id"),
            get_current_page_number: t => {
                var a = wcpt_util.get_table_parsed_query(t),
                    e = wcpt_util.get_table_id(t),
            ...
            get_table_parsed_query: t => {
                var a = t.attr("data-wcpt-query-string"),
                    e = a.indexOf("?"),
                    c = -1 == e ? {} : wcpt_util.parse_query_string(a.slice(e + 1));
                return c
            },
            ...
            assign_even_odd_row_classes: a => {
                var e = t(".wcpt-row:not(.wcpt-child-row, .wcpt-row--category-heading):visible", a),
                    c = t(".wcpt-child-row", a);
                e.each(function() {
                    var a = t(this);
                    ...
                    var a = t(this),
                        e = a.data("wcpt_parent_row");
                    e.hasClass("wcpt-even") ? a.removeClass("wcpt-odd").addClass("wcpt-even") : a.removeClass("wcpt-even").addClass("wcpt-odd")
                })
            },
            update_url_by_container: t => {
                var a = wcpt_util.get_sc_attrs(t);
                if (!a.disable_url_update) {
                    var e = t.attr("data-wcpt-query-string");
                    wcpt_util.update_url_by_query(e)
                }
            },
