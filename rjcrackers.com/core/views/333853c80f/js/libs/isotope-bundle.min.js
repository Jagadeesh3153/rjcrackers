! function(t) {
    ...
    function i(a) {
        var h;
        if (a) return h = "undefined" == typeof console ? e : function(t) {
            console.error(t)
            ...
            (i = e).prototype.option || (i.prototype.option = function(t) {
                ...
                for (var t = p.call(arguments, 1), i = 0, o = this.length; i < o; i++) {
                    var n = this[i],
                        n = a.data(n, r);
                    if (n)
                        if ("function" != typeof n[e] || "_" === e.charAt(0)) h("no such method '" + e + "' for " + r + " instance");
                        else {
                            n = n[e].apply(n, t);
...
function(i) {
    ...
    var n = function() {},
        t = (t.removeEventListener ? n = function(t, e, i) {
...
function() {
    ...
    function(M) {
        ...
        function t(E) {
            ...
            return function(t) {
                var e, i;
                if (!P && (P = !0, e = M.getComputedStyle, i = e ? function(t) {
                        return e(t, null)
                    } : function(t) {
                    ...
                    if ("none" === o.display) {
                        for (var n = {
                                ...
                                outerWidth: 0,
                                outerHeight: 0
                            }, r = 0, s = D.length; r < s; r++) n[D[r]] = 0;
                        return n
                    }
                    for (var a, h, p, u, c = {}, l = (c.width = t.offsetWidth, c.height = t.offsetHeight, c.isBorderBox = !(!T || !o[T] || "border-box" !== o[T])), d = 0, f = D.length; d < f; d++) {
                        var y = D[d],
                            m = o[y],
                            g = (g = t, m = m, u = p = h = a = void 0, M.getComputedStyle || -1 === m.indexOf("%") || (a = g.style, h = a.left, p = g.runtimeStyle, (u = p && p.left) && (p.left = g.currentStyle.left), a.left = m, m = a.pixelLeft, a.left = h, u && (p.left = u)), parseFloat(m));
                        c[y] = isNaN(g) ? 0 : g
                    }
                    var v = c.paddingLeft + c.paddingRight,
                        _ = c.paddingTop + c.paddingBottom,
                        x = c.marginLeft + c.marginRight,
                        I = c.marginTop + c.marginBottom,
                        z = c.borderLeftWidth + c.borderRightWidth,
                        w = c.borderTopWidth + c.borderBottomWidth,
                        L = l && R,
                        S = O(o.width),
                        S = (!1 !== S && (c.width = S + (L ? 0 : v + z)), O(o.height));
                    return !1 !== S && (c.height = S + (L ? 0 : _ + w)), c.innerWidth = c.width - (v + z), c.innerHeight = c.height - (_ + w), c.outerWidth = c.width + x, c.outerHeight = c.height + I, c
                }
            }
        }
        "function" == typeof define && define.amd ? define("get-size/get-size", ["get-style-property/get-style-property"], t) : "object" == typeof exports ? module.exports = t(require("desandro-get-style-property")) : M.getSize = t(M.getStyleProperty)
    }(window),
    function(e) {
        var i = e.document,
            o = [];
        ...
        function s() {
            n.isReady = !0;
            for (var t = 0, e = o.length; t < e; t++)(0, o[t])()
        }

        function t(t) {
            return "complete" === i.readyState ? s() : (t.bind(i, "DOMContentLoaded", r), t.bind(i, "readystatechange", r), t.bind(e, "load", r)), n
        }
    ...
    function(i, o) {
        ...
        var i, l = {
            ...
            d = (l.isArray = function(t) {
                ...
                e = l.indexOf(t, e); - 1 != e && t.splice(e, 1)
            }, l.isElement = "object" == typeof HTMLElement ? function(t) {
                return t instanceof HTMLElement
            } : function(t) {
                return t && "object" == typeof t && null !== t && 1 == t.nodeType && "string" == typeof t.nodeName
                ...
                for (var i = [], o = 0, n = (t = l.makeArray(t)).length; o < n; o++) {
                    ...
                    if (l.isElement(r))
                        if (e) {
                            p(r, e) && i.push(r);
                            for (var s = r.querySelectorAll(e), a = 0, h = s.length; a < h; a++) i.push(s[a])
                        } else i.push(r)
                }
                return i
        ...
        return l.htmlInit = function(p, u) {
            t(function() {
                for (var t = l.toDashed(u), e = document.querySelectorAll(".js-" + t), i = "data-" + t + "-options", o = 0, n = e.length; o < n; o++) {
                    var r, s = e[o],
                        a = s.getAttribute(i);
                    try {
                        r = a && JSON.parse(a)
                    } catch (t) {
                        d && d.error("Error parsing " + i + " on " + s.nodeName.toLowerCase() + (s.id ? "#" + s.id : "") + ": " + t);
                        continue
                    }
                    var a = new p(s, r),
                        h = c.jQuery;
    ...
    function(n, r) {
        ...
        o.extend(l.prototype, e.prototype), l.prototype._create = function() {
            this._transn = {
                ingProperties: {},
                clean: {},
                onEnd: {}
            ...
            var t = s(this.element),
                ...
                t = t[e ? "top" : "bottom"],
                n = this.layout.size,
                o = -1 != o.indexOf("%") ? parseFloat(o) / 100 * n.width : parseInt(o, 10),
                t = -1 != t.indexOf("%") ? parseFloat(t) / 100 * n.height : parseInt(t, 10),
                o = isNaN(o) ? 0 : o,
                t = isNaN(t) ? 0 : t;
            o -= i ? n.paddingLeft : n.paddingRight, t -= e ? n.paddingTop : n.paddingBottom, this.position.x = o, this.position.y = t
            ...
            var t = this.layout.size,
                ...
                n = (i[n] = this.getXValue(o), i[r] = "", e.isOriginTop ? "paddingTop" : "paddingBottom"),
                o = e.isOriginTop ? "top" : "bottom",
                r = e.isOriginTop ? "bottom" : "top",
                e = this.position.y + t[n];
            i[o] = this.getYValue(e), i[r] = "", this.css(i), this.emitEvent("layout", [this])
        }, l.prototype.getXValue = function(t) {
            var e = this.layout.options;
            return e.percentPosition && !e.isHorizontal ? t / this.layout.size.width * 100 + "%" : t + "px"
        }, l.prototype.getYValue = function(t) {
            var e = this.layout.options;
            return e.percentPosition && e.isHorizontal ? t / this.layout.size.height * 100 + "%" : t + "px"
        }, l.prototype._transitionTo = function(t, e) {
            this.getPosition();
            var i = this.position.x,
                o = this.position.y,
                n = parseInt(t, 10),
                r = parseInt(e, 10),
                n = n === this.position.x && r === this.position.y;
            this.setPosition(t, e), n && !this.isTransitioning ? this.layoutPosition() : ((r = {}).transform = this.getTranslate(t - i, e - o), this.transition({
                to: r,
                onTransitionEnd: {
        ...
        }, l.prototype.getTranslate = function(t, e) {
            var i = this.layout.options;
            return t = i.isOriginLeft ? t : -t, e = i.isOriginTop ? e : -e, h ? "translate3d(" + t + "px, " + e + "px, 0)" : "translate(" + t + "px, " + e + "px)"
        }, l.prototype.goTo = function(t, e) {
            this.setPosition(t, e), this.layoutPosition()
        }, l.prototype.moveTo = t ? l.prototype._transitionTo : l.prototype.goTo, l.prototype.setPosition = function(t, e) {
            this.position.x = parseInt(t, 10), this.position.y = parseInt(e, 10)
        }, l.prototype._nonTransition = function(t) {
        ...
        var d = "opacity," + (c.transform || "transform").replace(/([A-Z])/g, function(t) {
                return "-" + t.toLowerCase()
            }),
            f = (l.prototype.enableTransition = function() {
                this.isTransitioning || (this.css({
                    transitionProperty: d,
                    transitionDuration: this.layout.options.transitionDuration
                }), this.element.addEventListener(p, this, !1))
            }, l.prototype.transition = l.prototype[a ? "_transition" : "_nonTransition"], l.prototype.onwebkitTransitionEnd = function(t) {
                this.ontransitionend(t)
            }, l.prototype.onotransitionend = function(t) {
                this.ontransitionend(t)
            }, {
            ...
            y = (l.prototype.ontransitionend = function(t) {
                var e, i;
            ...
            }, l.prototype._removeStyles = function(t) {
                var e, i = {};
                for (e in t) i[e] = "";
                this.css(i)
            }, {
        ...
        return l.prototype.removeTransitionStyles = function() {
            this.css(y)
        ...
        }, l.prototype.onRevealTransitionEnd = function() {
            this.isHidden || this.emitEvent("reveal")
        }, l.prototype.getHideRevealTransitionEndProperty = function(t) {
        ...
        }, l.prototype.onHideTransitionEnd = function() {
    ...
    function(r, s) {
        ...
        function c(t, e) {
            ...
            i ? (this.element = i, h && (this.$element = h(this.element)), this.options = r.extend({}, this.constructor.defaults), this.option(e), e = ++p, this.element.outlayerGUID = e, (u[e] = this)._create(), this.options.isInitLayout && this.layout()) : a && a.error("Bad element for " + this.constructor.namespace + ": " + (i || t))
        }
        return c.namespace = "outlayer", c.Item = o, c.defaults = {
            containerStyle: {
                position: "relative"
            },
            isInitLayout: !0,
        ...
        }, r.extend(c.prototype, i.prototype), c.prototype.option = function(t) {
        ...
        }, c.prototype._getMeasurement = function(t, e) {
            var i, o = this.options[t];
            o ? ("string" == typeof o ? i = this.element.querySelector(o) : r.isElement(o) && (i = o), this[t] = i ? n(i)[e] : o) : this[t] = 0
        }, c.prototype.layoutItems = function(t, e) {
            t = this._getItemsForLayout(t), this._layoutItems(t, e), this._postLayout()
        }, c.prototype._getItemsForLayout = function(t) {
            for (var e = [], i = 0, o = t.length; i < o; i++) {
                var n = t[i];
                n.isIgnored || e.push(n)
            }
            return e
        }, c.prototype._layoutItems = function(t, e) {
        ...
        }, c.prototype._getItemLayoutPosition = function() {
            return {
                x: 0,
                y: 0
            }
        }, c.prototype._processLayoutQueue = function(t) {
            for (var e = 0, i = t.length; e < i; e++) {
                var o = t[e];
                this._positionItem(o.item, o.x, o.y, o.isInstant)
            }
        }, c.prototype._positionItem = function(t, e, i, o) {
            o ? t.goTo(e, i) : t.moveTo(e, i)
        }, c.prototype._postLayout = function() {
            this.resizeContainer()
        }, c.prototype.resizeContainer = function() {
            var t;
        ...
        }, c.prototype._getContainerSize = s, c.prototype._setContainerMeasure = function(t, e) {
            var i;
        ...
        }, c.prototype._emitCompleteOnItems = function(t, e) {
            var i = this;
            ...
            var n = e.length;
            if (e && n)
                for (var r = 0, s = 0, a = e.length; s < a; s++) e[s].once(t, h);
            else o();
            ...
            t = this.getItem(t);
            t && (t.isIgnored = !0)
        }, c.prototype.unignore = function(t) {
            t = this.getItem(t);
            t && delete t.isIgnored
        }, c.prototype.stamp = function(t) {
            if (t = this._find(t)) {
        ...
        }, c.prototype._getBoundingRect = function() {
        ...
        }, c.prototype._manageStamp = s, c.prototype._getElementOffset = function(t) {
        ...
        }, c.prototype.addItems = function(t) {
            t = this._itemize(t);
        ...
        }, c.prototype.revealItemElements = function(t) {
            t = this.getItems(t);
            this.reveal(t)
        }, c.prototype.hideItemElements = function(t) {
            t = this.getItems(t);
            this.hide(t)
        ...
        }, c.prototype.getItems = function(t) {
            ...
            return Object.create ? i.prototype = Object.create(c.prototype) : r.extend(i.prototype, c.prototype), (i.prototype.constructor = i).defaults = r.extend({}, c.defaults), r.extend(i.defaults, e), i.prototype.settings = {}, i.namespace = t, i.data = c.data, (i.Item = function() {
                o.apply(this, arguments)
            }).prototype = new o, r.htmlInit(i, t), h && h.bridget && h.bridget(t, i), i
        }, c.Item = o, c
    }),
    function(t, e) {
        "use strict";
    ...
    function(t, e) {
        ...
        for (var t = ["_resetLayout", "_getItemLayoutPosition", "_manageStamp", "_getContainerSize", "_getElementOffset", "needsResizeLayout"], n = 0, r = t.length; n < r; n++) {
            var s = t[n];
        ...
        return o.prototype.needsVerticalResizeLayout = function() {
            ...
            return i.prototype = new o, e && (i.options = e), o.modes[i.prototype.namespace = t] = i
        }, o
    }),
    function(t, e) {
        "use strict";
        ...
        return t.prototype._resetLayout = function() {
            ...
            t.getSize();
            for (var e = t.size.outerWidth % this.columnWidth, e = Math[e && e < 1 ? "round" : "ceil"](t.size.outerWidth / this.columnWidth), e = Math.min(e, this.cols), e = this._getColGroup(e), i = Math.min.apply(Math, e), o = h.indexOf(e, i), n = {
                    x: this.columnWidth * o,
                    y: i
                }, r = i + t.size.outerHeight, s = this.cols + 1 - e.length, a = 0; a < s; a++) this.colYs[o + a] = r;
            return n
            ...
            for (var e = a(t), t = this._getElementOffset(t), i = this.options.isOriginLeft ? t.left : t.right, o = i + e.outerWidth, i = Math.floor(i / this.columnWidth), i = Math.max(0, i), n = Math.floor(o / this.columnWidth), r = (n -= o % this.columnWidth ? 0 : 1, n = Math.min(this.cols - 1, n), (this.options.isOriginTop ? t.top : t.bottom) + e.outerHeight), s = i; s <= n; s++) this.colYs[s] = Math.max(r, this.colYs[s])
    ...
    function(t, e) {
        ...
        var i, t = t.create("masonry"),
            o = t.prototype._getElementOffset,
            n = t.prototype.layout,
            r = t.prototype._getMeasurement,
            s = t.prototype,
            a = e.prototype;
        for (i in a) s[i] = a[i];
        t.prototype._getElementOffset = o, t.prototype.layout = n, t.prototype._getMeasurement = r;
        var h = t.prototype.measureColumns,
            p = (t.prototype.measureColumns = function() {
                this.items = this.isotope.filteredItems, h.call(this)
            }, t.prototype._manageStamp);
        return t.prototype._manageStamp = function() {
    ...
    function(s, a) {
        ...
        var a = t.jQuery,
            ...
            c = (u.Item = n, u.LayoutMode = s, u.prototype._create = function() {
                ...
                var e = this._filter(this.items),
                    i = (this.filteredItems = e.matches, this);
                ...
                for (var e = this.options.filter, i = [], o = [], n = [], r = this._getFilterTest(e || "*"), s = 0, a = t.length; s < a; s++) {
                    var h, p = t[s];
                    p.isIgnored || ((h = r(p)) && i.push(p), h && p.isHidden ? o.push(p) : h || p.isHidden || n.push(p))
                }
                return {
                    matches: i,
                    needReveal: o,
                ...
                var e, i, o, n, r;
                return "string" == typeof t && (o = (i = (e = h(t).split(" "))[0]).match(/^\[(.+)\]$/), n = function(e, i) {
                    var t;
                    t = e ? function(t) {
                    ...
                    return t
                }(o && o[1], i), t = (r = u.sortDataParsers[e[1]]) ? function(t) {
                    return t && r(n(t))
                } : function(t) {
                    return t && n(t)
                }), t
        ...
        u.sortDataParsers = {
            ...
            var t, a, h, e = this.options.sortBy;
            e && (t = [].concat.apply(e, this.sortHistory), a = t, h = this.options.sortAscending, this.filteredItems.sort(function(t, e) {
                for (var i = 0, o = a.length; i < o; i++) {
                    var n = a[i],
                        r = t.sortData[n],
                        s = e.sortData[n];
                    if (s < r || r < s) return (s < r ? 1 : -1) * ((void 0 !== h[n] ? h[n] : h) ? 1 : -1)
                }
                return 0
        ...
        return u.prototype.remove = function(t) {
            ...
            var e = this.options.transitionDuration,
                t = (this.options.transitionDuration = 0, t.call(this));
    ...
    function(t) {
        function e() {
            ...
            return (i.Rect = a).defaults = {
                ...
                var e, i, o, n, r, s;
                return !!this.overlaps(t) && (i = [], o = this.x + this.width, n = this.y + this.height, r = t.x + t.width, s = t.y + t.height, this.y < t.y && (e = new a({
                    x: this.x,
                    y: this.y,
                    width: this.width,
                    height: t.y - this.y
    ...
    function(t) {
                ...
                for (var e = 0, i = t.length; e < i; e++) {
                    ...
                    if (o) {
                        ...
                        for (var r = 0, s = 0, a = n.length; s < a; s++) {
                            var h = n[s],
                                p = s < e ? 0 : 1;
                            o.contains(h) && (t.splice(s + p - r, 1), r++)
                        }
                    }
                }
                return t
        ...
        "function" == typeof define && define.amd ? define("packery/js/packer", ["./rect"], e) : "object" == typeof exports ? module.exports = e(require("./rect")) : (t = t.Packery = t.Packery || {}).Packer = e(t.Rect)
    }(window),
    function(t) {
        function e(t, e, i) {
            function o() {
            ...
            return o.prototype._create = function() {
                ...
                var o = e ? "Width" : "Height",
                    ...
                    o = this.layout.size["inner" + o];
                return e || (o = Math.max(o, this.layout.maxY), this.layout.rowHeight) || (o -= this.layout.gutter), e = r ? (r += this.layout.gutter, o += e ? this.layout.gutter : 0, t = Math.round(t / r), e = this.layout.options.isHorizontal ? e ? "ceil" : "floor" : e ? "floor" : "ceil", e = Math[e](o / r), e -= Math.ceil(n / r)) : o - n, t = i ? t : Math.min(t, e), t *= r || 1, Math.max(0, t)
    ...
    function(t) {
        function e(s, o, t, i, e, n) {
            ...
            return h.Item = n, h.prototype._create = function() {
            ...
            }, h.prototype._setRectSize = function(t, e) {
                var t = o(t),
                    i = t.outerWidth,
                    t = t.outerHeight;
                ...
                e = e && e.isPlacing ? e.placeRect : (e = this._getElementOffset(t), new i({
                ...
                t = this.getItem(t);
                t && (this._getMeasurements(), this.stamp(t.element), t.getSize(), t.isPlacing = !0, e = void 0 === e ? t.rect.x : e, i = void 0 === i ? t.rect.y : i, t.positionPlaceRect(e, i, !0), this._bindFitEvents(t), t.moveTo(t.placeRect.x, t.placeRect.y), this.layout(), this.unstamp(t.element), this.sortItemsByPosition(), t.isPlacing = !1, t.copyPlaceRectPosition())
            ...
            }, h.prototype.itemDragEnd = function(t) {
                var e, i = this.getItem(t);
                i && (e = i.didDrag, i.dragStop()), i && (e || i.needsPositioning) ? (s.add(i.element, "is-positioning-post-drag"), e = this._getDragEndLayoutComplete(t, i), i.needsPositioning ? (i.on("layout", e), i.moveTo(i.placeRect.x, i.placeRect.y)) : i && i.copyPlaceRectPosition(), this.clearDragTimeout(), this.on("layoutComplete", e), this.layout()) : this.unstamp(t)
            }, h.prototype._getDragEndLayoutComplete = function(t, e) {
    ...
    function(t) {
        function e(t, e, o) {
            var i, t = t.create("packery"),
                n = t.prototype._getElementOffset,
                r = t.prototype._getMeasurement,
                s = t.prototype,
                a = e.prototype;
            for (i in a) s[i] = a[i];
            t.prototype._getElementOffset = n, t.prototype._getMeasurement = r;
            var h = t.prototype._resetLayout,
                p = (t.prototype._resetLayout = function() {
                    this.packer = this.packer || new e.Packer, h.apply(this, arguments)
                }, t.prototype._getItemLayoutPosition),
                u = (t.prototype._getItemLayoutPosition = function(t) {
                    return t.rect = t.rect || new e.Rect, p.call(this, t)
                }, t.prototype._manageStamp);
            return t.prototype._manageStamp = function() {
